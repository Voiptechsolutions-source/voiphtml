...
<!-- Start Main Content -->
 <main>
                      ...
                      <form id="dataform" method="post" novalidate>
                        ...
                        <div class="form-group">
                           <textarea name="msg" id="message" class="form-control" placeholder="Describe Your Need"></textarea>
                             <input type="hidden" name="service_type" value="voip">
        ...
        <div class="container">
            ...
            <div class="row flex-column-reverse flex-md-row-reverse align-items-center _feat-box mt-5">
                <div class="col col-md-6">
                    ...
                    <h2>Manage global calls with crystal-clear <span class="text-orange">voice quality</span></h2>
                    <div class="_content">
                        <p>Handle international and domestic calls effortlessly with our high-quality VoIP minutes, ensuring smooth communication across borders without network dropouts, static, or delays—ideal for enterprises and wholesale carriers who prioritize reliability.</p>
                    </div>
            ...
            <div class="row flex-column-reverse flex-md-row align-items-center _feat-box py-80">
                <div class="col col-md-6">
                    ...
                    <h2>Scale your <span class="text-orange">call capacity</span> without infrastructure costs</h2>
                    <div class="_content">
                       
                        <p>Instantly increase your traffic handling using our cloud-based VoIP services. No need for expensive hardware or complex setups—scale call volume on demand and expand your reach with minimal investment and maximum return.</p>
                    </div>
            ...
            <div class="row flex-column-reverse flex-md-row-reverse align-items-center _feat-box">
                <div class="col col-md-6">
                    ...
                    <h2>Access premium <span class="text-orange">CLI/NCLI routes</span> in real time</h2>
                    <div class="_content">
                        <p>Choose from top-tier CLI/NCLI routes tailored to your traffic needs. Our dynamic routing ensures high ASR and ACD, offering cost-effective solutions while maintaining compliance and global call clarity..</p>
                    </div>
                    <div class="demo-btn mt-4">
                        <a href="#" data-toggle="modal" data-target="#myModalForm" class="btn bg-orange text-white rounded-pill  px-4 text-uppercase">Get Demo</a>
                    </div>
            ...
            <div class="row flex-column-reverse flex-md-row align-items-center _feat-box">
                <div class="col col-md-6">
                    <!-- <p class="text-orange">Tailored Communication Solutions</p> -->
                    <h2>Maximize margins with optimized <span class="text-orange">wholesale VoIP</span></h2>
                    <div class="_content">
                        <p>Leverage our competitive VoIP termination rates and route quality to improve your profit margins. Whether you're a reseller or telecom provider, our network is built to support large-scale voice traffic with ease..</p>
                    </div>
                    <div class="demo-btn mt-4">
                        <a href="#" data-toggle="modal" data-target="#myModalForm" class="btn bg-orange text-white rounded-pill  px-4 text-uppercase">Get Demo</a>
                    </div>
            ...
            <div class="row align-items-center">
                <div class="col-12 col-lg-6">
                    <div class="section-title text-center">
                        <h2 class="text-orange"> Smart Routing</h2>
                    </div>
                </div>
                <div class="col-12 col-lg-6">
                    ...
                    <div class="_services-boxes">
                        <div class="row">
                            ...
                            <div class="col-12 col-lg-3">
                                <div class="_service">
                                    <div class="_img">
                                        <img src="assets/images/Wholesale-VoIP.png" alt="Service Type" />
                                    </div>
                                    <div class="title">Wholesale VoIP</div>
                            ...
                            <div class="col-12 col-lg-3">
                                <div class="_service">
                                    <div class="_img">
                                        <img src="assets/images/Remote-Workforce.png" alt="Service Type" />
                                    </div>
                                    <div class="title">Remote Workforce</div>
                            ...
                            <div class="col-12 col-lg-3">
                                <div class="_service">
                                    <div class="_img">
                                        <img src="assets/images/International-Calling.png" alt="Service Type" />
                                    </div>
                                    <div class="title">International Calling</div>
                            ...
                            <div class="col-12 col-lg-3">
                                <div class="_service">
                                    <div class="_img">
                                        <img src="assets/images/cc-solution.png" alt="Service Type" />
                                    </div>
                                    <div class="title">Call Center Solutions</div>
            ...
            <div class="row text-center">
                <div class="col-12 col-lg-4">
                    <div class="solution-box">
                        ...
                        <div class="desc">
                            <p>Seamless, uninterrupted calls ensure your business stays connected anytime, anywhere globally.</p>
                        </div>
                    </div>
                </div>
                <div class="col-12 col-lg-4">
                    <div class="solution-box">
                        ...
                        <div class="title">Scalable Solutions</div>
                        <div class="desc">
                            <p>Easily expand your VoIP services to match your growing business needs..</p>
                        </div>
                    </div>
                </div>
                <div class="col-12 col-lg-4">
                    <div class="solution-box">
                        ...
                        <div class="title">Cost-Effective Plans</div>
                        <div class="desc">
                            <p>Affordable pricing models designed to maximize value without compromising call quality..</p>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <section class="support-you-section  mt-4">
        <div class="container">
            <div class="section-title text-center">
                <h2>Here to <span class="text-orange">Support You</span> Whenever Needed</h2>
            </div>
            ...
            <div class="support-cta p-5 bg-dark text-white text-center">
                <div class="heading h2 font-weight-bold mb-4">Get Personalized <br> Advice from <span class="text-orange">Specialists</span> </div>
                <p>If you want to explore these features or have questions, let’s schedule a demo to show you how it works.</p>
                <div class="_btn mt-4">
                    ...
                    <div class="accordion" id="faq">
                        ...
                        <div class="card">
                            <div class="card-header" id="faqhead1">
                                    <h3 class="mb-0">
                                <a href="#" class="btn btn-header-link" data-toggle="collapse" data-target="#faq1" aria-expanded="true" aria-controls="faq1">Does your VoIP service support call center features like IVR and ACD?</a>
                                </h3>
                            </div>

                            <div id="faq1" class="collapse show" aria-labelledby="faqhead1" data-parent="#faq">
                                <div class="card-body">
                                Yes, we provide interactive voice response (IVR) and automatic call distribution (ACD) systems to streamline call management.
                                </div>
                            </div>
                        </div>
                        <!-- Faq 2-->
                        <div class="card">
                            <div class="card-header" id="faqhead2">
                                    <h3 class="mb-0">
                                <a href="#" class="btn btn-header-link collapsed" data-toggle="collapse" data-target="#faq2" aria-expanded="true" aria-controls="faq2">How can I integrate your VoIP service with my CRM system?</a>
                                </h3>
                            </div>

                            <div id="faq2" class="collapse" aria-labelledby="faqhead2" data-parent="#faq">
                                <div class="card-body">
                            We offer API integrations with popular CRMs such as Salesforce, HubSpot, and Zoho to improve agent efficiency.
                                </div>
                            </div>
                        </div>
                        <!-- Faq 3-->
                        <div class="card">
                            <div class="card-header" id="faqhead3">
                                    <h3 class="mb-0">
                                <a href="#" class="btn btn-header-link collapsed" data-toggle="collapse" data-target="#faq3" aria-expanded="true" aria-controls="faq3">Can I track agent performance using your VoIP service?</a>
                                </h3>
                            </div>

                            <div id="faq3" class="collapse" aria-labelledby="faqhead3" data-parent="#faq">
                                <div class="card-body">
                                Yes, we provide call analytics, agent performance metrics, and real-time monitoring tools.
                                </div>
                            </div>
                        </div>
                        <!-- Faq 4-->
                        <div class="card">
                            <div class="card-header" id="faqhead4">
                                    <h3 class="mb-0">
                                <a href="#" class="btn btn-header-link collapsed" data-toggle="collapse" data-target="#faq4" aria-expanded="true" aria-controls="faq4">What options are available for call routing and management?</a>
                                </h3>
                            </div>

                            <div id="faq4" class="collapse" aria-labelledby="faqhead4" data-parent="#faq">
                                <div class="card-body">
                                We offer advanced call routing options, including skills-based routing, time-of-day routing, and geographic routing to optimize call flow.
                                </div>
                            </div>
                        </div>
                        <!-- Faq 5-->
                        <div class="card">
                            <div class="card-header" id="faqhead5">
                                    <h3 class="mb-0">
                                <a href="#" class="btn btn-header-link collapsed" data-toggle="collapse" data-target="#faq5" aria-expanded="true" aria-controls="faq5">How does your VoIP handle high call volumes during peak hours?</a>
                                </h3>
                            </div>

                            <div id="faq5" class="collapse" aria-labelledby="faqhead5" data-parent="#faq">
                                <div class="card-body">
                                Our platform is designed to scale automatically, ensuring quality and reliability during peak traffic with minimal latency.
                                </div>
                            </div>
                        </div>
                        <!-- Faq 6-->
                        <div class="card">
                            <div class="card-header" id="faqhead6">
                                    <h3 class="mb-0">
                                <a href="#" class="btn btn-header-link collapsed" data-toggle="collapse" data-target="#faq6" aria-expanded="true" aria-controls="faq6">Can I set up a call queue system with your VoIP?</a>
                                </h3>
                            </div>

                            <div id="faq6" class="collapse" aria-labelledby="faqhead6" data-parent="#faq">
                                <div class="card-body">
                                Yes, you can configure call queues with customizable hold music, wait times, and priority handling.
                                </div>
                            </div>
                        </div>
                        <!-- Faq 7-->
                        <div class="card">
                            <div class="card-header" id="faqhead7">
                                <h3 class="mb-0">
                                <a href="#" class="btn btn-header-link collapsed" data-toggle="collapse" data-target="#faq7" aria-expanded="true" aria-controls="faq7">Is there a way to provide real-time call monitoring or whispering for supervisors?</a>
                                </h3>
                            </div>

                            <div id="faq7" class="collapse" aria-labelledby="faqhead7" data-parent="#faq">
                                <div class="card-body">
                                Yes, our platform supports live call monitoring, whispering, and barge-in for supervisors to assist agents without interrupting the call.
                                </div>
                            </div>
                        </div>
                        <!-- Faq 8-->
                        <div class="card">
                            <div class="card-header" id="faqhead8">
                                <h3 class="mb-0">
                                <a href="#" class="btn btn-header-link collapsed" data-toggle="collapse" data-target="#faq8" aria-expanded="true" aria-controls="faq8">Do you offer call recording features for quality assurance?</a>
                                </h3>
                            </div>

                            <div id="faq8" class="collapse" aria-labelledby="faqhead8" data-parent="#faq">
                                <div class="card-body">
                                Yes, we provide call recording with the ability to review, search, and analyze recorded calls for training and compliance purposes.
                                </div>
                            </div>
                        </div>
                        <!-- Faq 9-->
                        <div class="card">
                            <div class="card-header" id="faqhead9">
                                <h3 class="mb-0">
                                <a href="#" class="btn btn-header-link collapsed" data-toggle="collapse" data-target="#faq9" aria-expanded="true" aria-controls="faq9">Is your VoIP platform compliant with call center regulations like PCI-DSS and HIPAA?</a>
                                </h3>
                            </div>

                            <div id="faq9" class="collapse" aria-labelledby="faqhead9" data-parent="#faq">
                                <div class="card-body">
                                Yes, our service complies with major call center regulations, including PCI-DSS and HIPAA, to protect sensitive customer data.
                                </div>
                            </div>
                        </div>
                        <!-- Faq 10-->
                        <div class="card">
                            <div class="card-header" id="faqhead10">
                                <h3 class="mb-0">
                                <a href="#" class="btn btn-header-link collapsed" data-toggle="collapse" data-target="#faq10" aria-expanded="true" aria-controls="faq10">How does your VoIP service ensure uptime and reliability for call centers?</a>
                                </h3>
                            </div>

                            <div id="faq10" class="collapse" aria-labelledby="faqhead10" data-parent="#faq">
                                <div class="card-body">
                                We offer 99.99% uptime SLA, geo-redundant infrastructure, and failover solutions to ensure continuous service for your call center operations.
                                </div>
                            </div>
                        </div>
                    </div>
