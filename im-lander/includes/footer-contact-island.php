<section class="footer-contact-island bg-black py-1">
            <div class="container">
                <div class="row mb-5">
                    <div class="col-md-12">
                        ...
                        <div class="row footer-island p-5 bg-white">
                            <div class="col-lg-4 col-md-4 mt-2">
                                ...
                                <div class="col-md-12  d-flex gap-2 top-footer-call">
                                    ...
                                    <div class="contact-txt">
                                        <div class="text-dark fw-bold">Call Us</div>
                                        <p><a href="tel:+971504583131"><b class="site_color">+(971) 50 458 3131</b></a></p>
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                    ...
                                    <div class="col-md-12  d-flex gap-2 top-footer-call">
                                        ...
                                        <div class="contact-txt">
                                            <div class="text-dark fw-bold">Mail Us</div>
                                            <p><a href="mailto:info@impressionmedia.ae"><b class="site_color">info@impressionmedia.ae</b></a></p>
                                        </div>
