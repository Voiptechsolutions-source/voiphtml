...
<body>
    ...
    <main class="main-wrapper">
        <!-- Hero Section -->
        <section class="hero-section home-banner contact-page-banner">
        ...
        <!-- Section 3  Why Us -->
        <section class="contact-section-2 contact-info bg-black">
            <div class="container">
                <div class="contact-cta">
                    <div class="phone-no-info _info-box">
                        <div class="_icn">
                            <img src="assets/images/icons/phone-icn.png" alt="Phone Icon">
                        </div>
                        <div class="_txt">
                            <a href="tel:+971504583131" class="phone-no">+(971) 50 458 3131</a>
                        </div>
                        <div class="_btn">
                            <a href="#" class="btn btn-dark rounded-pill text-uppercase">Call Now For Query</a>
                        </div>
                    </div>
                    <div class="devider"></div>
                    <div class="email-info _info-box">
                        <div class="_icn">
                            <img src="assets/images/icons/email-icn.png" alt="Phone Icon">
                        </div>
                        <div class="_txt">
                            <a href="mailto:info@impressionmedia.ae" class="phone-no">info@impressionmedia.ae</a>
                        </div>
                        <div class="_btn">
                            <a href="#" class="btn btn-dark rounded-pill text-uppercase">Call Now For Query</a>
                        </div>
 ...
 <script src="assets/js/contact-us-effects.js"></script>
</body>
</html>