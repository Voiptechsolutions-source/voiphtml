...
<body>
    ...
    <main class="main-wrapper">
        <!-- Hero Section -->
        <section class="hero-section home-banner all-services-banner">
                    ...
                    <div class="row  align-items-center">
                        <div class="col-12 col-lg-6 hero-left">
                            <div class="banner-text-cont">
                                <h1>Our Services In Digital Marketing</h1>
                        ...
                        <div class="col-12 col-lg-6 hero-right">
                            <div class="banner-img">
                                <img src="assets/images/all-services-banner.webp" alt="Hero image" class="img-fluid" />
                            </div>
                        </div>
                ...
                <div class="vimi-cont">
                    <div class="row">
                        <div class="col-12 col-lg-4">
                            <div class="vimi-box vimi-left shadow-lg vim-box1">
                        ...
                        <div class="col-12 col-lg-4">
                            <div class="vimi-box vimi-mid shadow-lg vim-box2">
                                <div class="vimi-content">
                                    <h2>Creative Ideas</h2>
                                    <p>Every business is unique. That's why we tailor our SEO and marketing services to meet your specific goals, industry requirements, and target audience.</p>
                                </div>
                        ...
                        <div class="col-12 col-lg-4">
                            <div class="vimi-box vimi-right shadow-lg vim-box3">
                                <div class="vimi-content">
                                    <h2>Creative Ideas</h2>
                                    <p>Every business is unique. That's why we tailor our SEO and marketing services to meet your specific goals, industry requirements, and target audience.</p>
                                </div>
