    ...
    <main class="main-wrapper">
                    ...
                    <div class="row  align-items-center">
                        <div class="col-12 col-lg-6 hero-left">
                            <div class="banner-text-cont">
                                <h1><span class="text-primary">Impression Media - </span> Digital Marketing Agency in Dubai that redefines ROI</h1>
        ...
        <div class="container">
            <div class="section-title text-center text-white">
                ...
                <h2>We’re Not Just a Marketing Company in Dubai, We’re Architects of Your Brand’s Digital Future</h2>
        ...
        <!-- Section 3  Why Us -->
        <section class="section-3 py-80 bg-light why-us-section">
            <div class="container">
                <div class="row">
                    <div class="col-12 col-lg-6">
                        <div class="why-us-img">
                            <img src="assets/images/why-us-section-img.webp" alt="Why Choose us" class="img-fluid" />
                        </div>
                    </div>
                    <div class="col-12 col-lg-6">
        ...
        <!-- Section 3.5 Our Vison and Mission -->
         <section class="section-3-5 section-vision bg-light pt-1 pb-5">
            <div class="container">
                <div class="vimi-cont">
                    <div class="row">
                        <div class="col-12 col-lg-6">
        ...
        <section class="section-6 py-5 bg-dark our-services-sec">
            <!-- CTA Box-->
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 col-lg-4">
                            <div class="service-box sma service-row-2">
                                <div class="service-icn"></div>
                                <div class="service-title">
                                    <h3><a href="socila-media-advertising.php">Social Media Advertising</a></h3>
                                </div>
                                <div class="service-desc">
                        ...
                        <div class="col-12 col-lg-4">
                            <div class="service-box ecom-mrkt service-row-2">
                                <div class="service-icn"></div>
                                <div class="service-title">
                                    <h3><a href="ecommerce-marketing.php">E-commerce Marketing</a></h3>
                                </div>
                                <div class="service-desc">
        ...
        <div class="container">
            <div class="our-features-home text-white">
                <div class="row">
                    <div class="col-12 col-lg-4">
                        <div class="feat-box">
                            <div class="_feat-img">
                                <img src="assets/images/feat-1.webp" alt="Precision Targeting" class="img-fluid">
                            </div>
                    ...
                    <div class="col-12 col-lg-4">
                        <div class="feat-box">
                            <div class="_feat-img">
                                <img src="assets/images/feat-2.webp" alt="Multi-Channel Campaigns" class="img-fluid">
                            </div>
                            <div class="feat-content">
                    ...
                    <div class="col-12 col-lg-4">
                        <div class="feat-box">
                            <div class="_feat-img">
                                <img src="assets/images/feat-3.webp" alt="Real-Time Optimization" class="img-fluid">
                            </div>
                            <div class="feat-content">
                                <h3>Real-Time Optimization</h3>
        ...
        <section class="section-9 bg-dark-blue py-5 blog-posts-home">
            <div class="container">
            ...
            <div class="container">
                <div class="mt-5 owl-carousel owl-theme blog-carousel text-white">
                    ...
                    <div class="blog-item">
                        ...
                        <div class="blog-img">
                            <a href="#"><img src="assets/images/blog-img4.png" alt="Blog Image 1" class="img-fluid"></a>
                        </div>
                        <div class="category-cont">
                            <a href="#" class="btn btn-default  rounded-pill">Boosting Sales for Grow</a>
                        </div>
