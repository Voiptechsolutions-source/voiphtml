...
<body>
    ...
    <main class="main-wrapper">
        <!-- Hero Section -->
        <section class="hero-section home-banner about-banner">
            ...
            <div class="container  position-relative ">
                <div class="banner-container">
                    <div class="about-banner-cont">
                        <div class="about-banner-img1">
                            <img src="assets/images/about-banner-img1.png" alt="" />
                        </div>
                        <div class="_content">
                        ...
                        <div class="about-banner-img2">
                            <img src="assets/images/about-banner-img2.png" alt="" />
                        </div>
                    </div>
        ...
        <!-- Section 2 -->
        <section class="section-2 py-5 welcome-to-im">
        <div class="container">
        ...
        <section class="section-3 py-80 bg-light why-us-section about-founder">
            <div class="container">
                <div class="row">
                    <div class="col-12 col-lg-6">
                        <div class="why-us-img">
                            <img src="assets/images/dwi.png" alt="Mr. Dwibendu" class="img-fluid" />
                        </div>
                    </div>
                    <div class="col-12 col-lg-6">
                        <div class="why-us-content">
                            <div class="content_img">
                                <img src="assets/images/why-us-content-img.png" alt="Mr. Dwibendu" class="img-fluid" />
                            </div>
                            <div class="_content">
        ...
        <!-- Section 3.5 Our Vison and Mission -->
         <section class="section-3-5 section-vision bg-light py-5 chalanges-section">
            <div class="container">
                <div class="vimi-cont">
                    <div class="row">
                        <div class="col-12 col-lg-6">
        ...
        <!-- Section 5.5 Time Line Section-->        
        <section class="section-5-5 py-5 bg-dark-blue">
            <div class="container">
                <!-- Time Line -->
