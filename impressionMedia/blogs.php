...
<body>
    ...
    <main class="main-wrapper">
        <!-- Hero Section -->
        <section class="hero-section home-banner blog-listing-banner">
                    ...
                    <div class="row  align-items-center justify-content-between">
                        <div class="col-12 col-lg-6 hero-right">
                            <div class="banner-img">
                                <img src="assets/images/blog-list-banner-img.webp" alt="" class="img-fluid" />
                            </div>
                        </div>
                        <div class="col-12 col-lg-6 hero-left">
                            <div class="banner-text-cont">
                                <h1>Boosting E-Commerce Sales with Google Shopping Ads</h1>
                                <div class="banner-tagline">We are a performance marketing agency in Dubai that specializes in data-driven digital campaigns that focus on measurable results such as leads, sales, and ROI. Leveraging platforms .</div>
                                <div class="read-time text-sm my-2">11 Minutes Read</div>
                                <div class="banner-bnt mt-3">
        ...
        <section class="blog-listing-section bg-dark pt-1 pb-5">
            <div class="container">
                <div class="section-title text-center text-white">
                    ...
                    <h2>What’s Happening in the Industry?</h2>
                </div>
 ...
 <script src="assets/js/blog-listing-effects.js"></script>
</body>
</html>