    ...
    <main class="main-wrapper">
                    ...
                    <div class="row  align-items-center">
                        <div class="col-12 col-lg-6 hero-left">
                            <div class="banner-text-cont">
                                ...
                                <div class="banner-tagline">We are a performance marketing agency in Dubai that specializes in data-driven digital campaigns that focus on measurable results such as leads, sales, and ROI. Leveraging platforms like Google Ads, Meta, and programmatic networks. </div>
        ...
        <div class="container">
            <div class="section-title text-center text-white">
                ...
                <h2>Our Expertise in Performance Marketing</h2>
                    ...
                    <div class="col-12 col-lg-6">
                        <div class="why-us-content">
                            ...
                            <div class="_content">
                                ...
                                <h2 class="text-light-orange">Why should you choose  Impression Media for Performance Marketing?</h2>
            ...
            <div class="container">
                ...
                <div class="stats-cont">
                    <div class="_stat">
                        ...
                        <div class="nos">300+</div>
                    </div>
                    <div class="_stat">
                        <div class="stat-title">Total Employees</div>
                        <div class="nos">575+</div>
                    </div>
                    <div class="_stat">
                    ...
                    <div class="_stat">
                        <div class="stat-title">Usefull Programs</div>
                        <div class="nos">245+</div>
                    </div>
                </div>
            </div>
        </section>
