<footer class="main-foorter bg-orange">
                 ...
                 <div class="col-lg-4 col-md-4 mt-2">
                    ...
                    <div class="row">
                            ...
                            <div class="col-md-12  d-flex gap-2 top-footer-call">
                              ...
                              <div class="contact-txt">
                                  <div class="text-dark">WhatsApp Us</div>
                                  <p><a href="https://wa.link/voiptech" target="_blank"><b class="site_color">+971-55-937-2131</b></a></p>
                              </div>
                    ...
                    <div class="row">
                            ...
                            <div class="col-md-12  d-flex gap-2 top-footer-call">
                              ...
                              <div class="contact-txt">
                                  ...
                                  <p><a href="mailto:sales@voiptechsolutions.com"><b class="site_color">sales@voiptechsolutions.com</b></a></p>
                              </div>
    ...
    <div class="container pt-2 pb-5">
     ...
     <!-- Footer Nav -->
      <div class="text-center col-12 col-md-5 mx-auto text-white">
      ...
      <div class="modal-body modal-form-body">
        ...
        <div class="banner-form contact-form">
          ...
          <div class="form-fields bg-white p-4">
           ...
           <form id="dataform2" method="post" novalidate>
                    <!-- Full Name -->
                    <div class="form-group">
                        <input type="text" id="full_name2" name="full_name" placeholder="Full Name" class="form-control" required="required">
                        <div id="nameError2" class="error-message"></div>
                    </div>
                    
                    <!-- Email -->
                    <div class="form-group">
                        <input type="email" id="email2" name="email" placeholder="Official E-mail Id" class="form-control">
                        <div id="emailError2" class="error-message"></div>
                    </div>
                    ...
                    <div class="form-group">
                        <div class="d-flex flex-row nuber-select">
                            ...
                            <input type="tel" id="contact_no2" name="contact_no" placeholder="WhatsApp Number/ Phone Number" class="form-control" maxlength="12">
                        </div>
                        <div id="contactError2" class="error-message"></div>
                    </div>
                    
                    <!-- Industry -->
                    <div class="form-group">
                        <select class="form-control" id="industry2" name="industry" required>
                        ...
                        <div id="industryError2" class="error-message"></div>
                    </div>
                    
                    <!-- Services -->
                    <div class="form-group">
                        <select class="form-control" id="services2" name="services">
                        ...
                        <div id="servicesError2" class="error-message"></div>
                    </div>
                    
                    <!-- Message -->
                    <div class="form-group">
                        <textarea name="msg" id="message2" class="form-control" placeholder="Describe Your Need"></textarea>
                        <input type="hidden" name="service_type" value="sms">
                        <input type="hidden" id="source2" name="source" >
                    </div>
                    
                    <div class="form-group text-center">
                        <button type="submit"  class="btn bg-orange text-white rounded-pill px-5 text-uppercase">GET A FREE DEMO</button>
                    </div>
                </form>   
      ...
      <div class="modal-body modal-form-body">
        ...
        <div class="banner-form contact-form">
          ...
          <div class="form-fields bg-white p-4">
               ...
               <form id="dataform2" method="post" enctype="multipart/form-data">  
                        <div class="form-group">
                             <input type="text" id="full_name2" name="full_name" placeholder="Full Name" class="form-control" required maxlength="500" />
                        </div>
                        <div class="form-group">
                            <input type="email" id="email2" name="email" placeholder="Official Email Id" class="form-control"  maxlength="5000" required />
                        </div>
                        <div class="form-group">
                            <div class="d-flex flex-row nuber-select">
                                <select class="form-control country-code" id="country_code2" name="country_code" style="width: 90px;">
                                ...
                                <input type="tel" id="contact_no2" name="contact_no" placeholder="WhatsApp Number/ Phone Number" oninput="validateContactNumber(event)" class="form-control" maxlength="12">
                        ...
                        <div class="form-group">
                            <textarea name="message" id="message2" class="form-control" placeholder="Describe Your Need"></textarea>
                            <input type="hidden" name="service_type" value="voip">
                        
                        <input type="hidden" id="source2" name="source">
                        <script>document.getElementById('source2').value = location.href;</script>
                        </div>
                        <div class="form-group text-center">
                            
                            <input type="button" id="send_button2" value="Get a Free Demo" class="btn bg-orange text-white rounded-pill px-5 text-uppercase">
                        </div>
                        </form>
