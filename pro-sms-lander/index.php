    ...
    <?php include 'includes/head-tags.php'; ?>
       <style>
        @media(min-width: 992px){
            #nav-useCase ._services-boxes ._service {
	            min-height: 360px;
            }
        }
       </style>
...
<!-- Start Main Content -->
 <main>
        ...
        <div class="container">
            <div class="d-flex justify-content-between flex-column flex-lg-row banner-content-container">
                ...
                <div class="banner-content">
                    <h1><span class="text-orange">Boost Connections </span> and Sales with Every SMS</h1>
                    <p>Connect with thousands instantly through SMS campaigns that spark action, raise awareness, and deliver real results.</p>
                    <div class="banner-feats">
                        <div class="feat-item">
                            ...
                            <div class="_feat">
                                ...
                                <p>Reach your audience in seconds without delays.</p>
                            </div>
                        </div>
                        <div class="feat-item">
                            ...
                            <div class="_feat">
                                ...
                                <p>Over 90% of SMS messages are opened and read quickly.</p>
                            </div>
                        </div>
                        <div class="feat-item">
                            <div class="feat-icn"><img src="assets/images/icons/feat-icn3.png" alt="Cost-Effective Communication"></div>
                            <div class="_feat">
                                <div class="_feat-head">Cost-Effective Marketing</div>
                                <p>An affordable way to promote offers and drive sales.</p>
                            </div>
                        </div>
                        <div class="feat-item">
                            <div class="feat-icn"><img src="assets/images/icons/feat-icn4.png" alt="Cost-Effective Communication"></div>
                            <div class="_feat">
                                <div class="_feat-head">Wide Reach</div>
                                <p>Send bulk messages to thousands of users effortlessly.</p>
                            </div>
                        </div>
                        <div class="feat-item">
                            <div class="feat-icn"><img src="assets/images/icons/feat-icn5.png" alt="Cost-Effective Communication"></div>
                            <div class="_feat">
                                <div class="_feat-head">Easy Campaign Management</div>
                                <p>Launch and track SMS campaigns with just a few clicks.</p>
                            </div>
                        </div>
                        <div class="feat-item">
                            <div class="feat-icn"><img src="assets/images/icons/feat-icn6.png" alt="Cost-Effective Communication"></div>
                            <div class="_feat">
                                <div class="_feat-head">Mobile-First Engagement</div>
                                <p>Connect with users directly where they are on their phones.</p>
                            </div>
                        </div>
                    </div>
                ...
                <!-- Hero image -->
                 <div class="banner-form contact-form">
                    ...
                    <div class="form-group text-center">
                        <button type="submit" id="send_button" class="btn bg-orange text-white rounded-pill px-5 text-uppercase">GET A FREE DEMO</button>
                    </div>
                </form>   
    ...
    <section class="features ">
        <div class="container">
            <!-- Faet 1 -->
            <div class="row flex-column-reverse flex-md-row-reverse align-items-center _feat-box mt-5">
                <div class="col col-md-6">
                    <!-- <p class="text-orange">Global Communication Solutions</p> -->
                    <h2>Reach global audiences with impactful <span class="text-orange">SMS campaigns</span></h2>
                    <div class="_content">
                        <p>Break through borders with VoIPTech Solutions Promotional SMS. Reach local and global audiences instantly, with flawless delivery, zero delays, and unmatched engagement built for enterprises and marketers who demand performance, precision, and conversion at scale.</p>
                    </div>
                ...
                <div class="col col-md-6">
                    <div class="feat-img">
                        <img src="assets/images/home-feat1.webp" alt="Comprehensive Digital Solutions" class="img-fluid" loading="lazy" />
                    </div>
                </div>
            </div>
            <!-- Faet 2 -->
            <div class="row flex-column-reverse flex-md-row align-items-center _feat-box py-80">
                <div class="col col-md-6">
                    <!-- <p class="text-orange">Powerful Call Center Tools</p> -->
                    <h2><span class="text-orange">Unleash Powerful Messaging</span> with Zero Infrastructure and Full Control</h2>
                    <div class="_content">
                       
                        <p>Why invest in expensive servers or gateways when you can scale smarter.VoIPTech Solutions cloud-powered Promotional SMS platform delivers enterprise-grade messaging without the burden of infrastructure costs. Enjoy instant scalability, secure delivery, and simplified operations all from a user-friendly interface that puts control in your hands, not in your server room.</p>
                    </div>
                ...
                <div class="col col-md-6">
                    <div class="feat-img">
                        <img src="assets/images/home-feat2.webp" alt="Powerful Call Center Tools" class="img-fluid" loading="lazy" />
                    </div>
                </div>
            </div>
            <!-- Faet 3 -->
            <div class="row flex-column-reverse flex-md-row-reverse align-items-center _feat-box">
                <div class="col col-md-6">
                    ...
                    <h2>Turn Every SMS into a <span class="text-orange">Personalized Experience</span> Amplified at Scale </h2>
                    <div class="_content">
                        <p>Why settle for generic messages when you can send tailored SMS campaigns that truly resonate. VoIPTech Solutions platform lets you easily customize and deliver personalized promotional SMS scaling your reach without the hassle. No extra tools. No manual work. Just targeted messages that connect, engage, and convert faster.</p>
                    </div>
                    <div class="demo-btn mt-4">
                        <a href="#" data-toggle="modal" data-target="#myModalForm" class="btn bg-orange text-white rounded-pill  px-4 text-uppercase">Get Demo</a>
                    </div>
                ...
                <div class="col col-md-6">
                    <div class="feat-img">
                        <img src="assets/images/home-feat3.webp" alt="Comprehensive Digital Solutions" class="img-fluid" loading="lazy" />
                    </div>
                </div>
            </div>
            <!-- Faet 4 -->
            <div class="row flex-column-reverse flex-md-row align-items-center _feat-box">
                <div class="col col-md-6">
                    <!-- <p class="text-orange">Tailored Communication Solutions</p> -->
                    <h2><span class="text-orange">Drive sales and genearte ROI</span> with advance segmentation </h2>
                    <div class="_content">
                        <p>Reach the right audience with the right message every time.VoIPTech Solutions Promotional SMS platform empowers you to segment your audience by location, behavior, or custom filters, ensuring every campaign hits with precision. With high-speed delivery and smart targeting, you’ll reduce waste, boost engagement, and drive real ROI from every SMS sent.</p>
                    </div>
                    <div class="demo-btn mt-4">
                        <a href="#" data-toggle="modal" data-target="#myModalForm" class="btn bg-orange text-white rounded-pill  px-4 text-uppercase">Get Demo</a>
                    </div>
                ...
                <div class="col col-md-6">
                    <div class="feat-img">
                        <img src="assets/images/home-feat4.webp" alt="Comprehensive Digital Solutions" class="img-fluid" loading="lazy" />
                    </div>
                </div>
            </div>
    ...
    <section class="cta ">
        <div class="container py-5 bg-orange rounded-xl">
            <!-- <p class="text-center">Struggling to Get </p> -->
            <h2 class="text-center">Tired of Low Engagement from Your SMS Campaigns? </h2>
            ...
            <div class="row align-items-center">
                <div class="col-12 col-lg-6">
                    <div class="section-title text-center">
                        <h2 class="text-orange">Instant Reach</h2>
                    </div>
                </div>
                <div class="col-12 col-lg-6">
    ...
    <section class="services-types mt-0">
        <div class="container">
            ...
            <div class="tab-content text-center" id="nav-tabContent">
                ...
                <div class="tab-pane fade" id="nav-useCase" role="tabpanel" aria-labelledby="nav-useCase-tab">
                    <div class="_services-boxes">
                        <div class="row">
                            <div class="col-12 col-lg-3">
                                <div class="_service">
                                    <div class="_img">
                                        <img src="assets/images/Flash-Sales-&-Promotions.png" alt="Flash Sales & Promotions" />
                                    </div>
                                    <div class="title">Flash Sales & Promotions</div>
                            ...
                            <div class="col-12 col-lg-3">
                                <div class="_service">
                                    <div class="_img">
                                        <img src="assets/images/New-Product-Launches.png" alt="New Product Launches" />
                                    </div>
                                    <div class="title">New Product Launches </div>
                            ...
                            <div class="col-12 col-lg-3">
                                <div class="_service">
                                    <div class="_img">
                                        <img src="assets/images/App-Download-Campaigns.png" alt="App Download Campaigns" />
                                    </div>
                                    <div class="title">App Download Campaigns</div>
                            ...
                            <div class="col-12 col-lg-3">
                                <div class="_service">
                                    <div class="_img">
                                        <img src="assets/images/Brand-Awareness-Activities.png" alt="Brand Awareness" />
                                    </div>
                                    <div class="title">Brand Awareness Activities </div>
            ...
            <div class="row text-center">
                <div class="col-12 col-lg-4">
                    <div class="solution-box">
                        <div class="icn-cont">
                            <img src="assets/images/icons/solution-icn1.png" alt="solution icon" />
                        </div>
                        <div class="title">Instant Customer Engagement</div>
                        <div class="desc">
                            <p>Connect with your audience instantly through fast, reliable SMS campaigns that boost response rates and brand loyalty.</p>
                        </div>
                    </div>
                </div>
                <div class="col-12 col-lg-4">
                    <div class="solution-box">
                        <div class="icn-cont">
                            <img src="assets/images/icons/solution-icn2.png" alt="solution icon" />
                        </div>
                        <div class="title">Effortless Scalability</div>
                        <div class="desc">
                            <p>Grow your SMS marketing seamlessly from small blasts to large-scale campaigns without missing a beat.</p>
                        </div>
                    </div>
                </div>
                <div class="col-12 col-lg-4">
                    <div class="solution-box">
                        <div class="icn-cont">
                            <img src="assets/images/icons/solution-icn3.png" alt="solution icon" />
                        </div>
                        <div class="title">Budget-Friendly SMS Plans</div>
                        <div class="desc">
                            <p>Maximize your marketing impact with affordable pricing tailored for businesses of every size.</p>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <section class="support-you-section mt-4">
        <div class="container">
            <div class="section-title text-center">
                <h2>We Are Always Ready to <span class="text-orange">Assist You</span> </h2>
            </div>
            <div class="form-section">
                <div class="row">
                    ...
                    <!-- Full Name -->
                    <div class="form-group">
                        <input type="text" id="full_name1" name="full_name" placeholder="Full Name" class="form-control" required="required">
                    ...
                    <!-- Message -->
                    <div class="form-group">
                        <textarea name="msg" id="message1" class="form-control" placeholder="Describe Your Need"></textarea>
                        <input type="hidden" name="service_type" value="sms">
                        <input type="hidden" id="source1" name="source" >
                    </div>
                    
                    <div class="form-group text-center">
                        <button type="submit" id="send_button1" class="btn bg-orange text-white rounded-pill px-5 text-uppercase">GET A FREE DEMO</button>
                    </div>
                </form>   
            ...
            <div class="support-cta p-5 bg-dark text-white text-center">
                <div class="heading h2 font-weight-bold mb-4">Get tailored advice and insights straight from our  <span class="text-orange">experts</span> </div>
                <p>Turn every message into a marketing win with VoIPTech Solutions,  contact us today to schedule a demo for a firsthand look.</p>
                <div class="_btn mt-4">
    ...
    <!-- FAQ Section -->
    <section class="faq-section faq py-80 bg-light near-footer mt-5" id="main">
        <div class="container">
            <div class="row">
                    ...
                    <div class="accordion" id="faq">
                        ...
                        <div class="card">
                            <div class="card-header" id="faqhead1">
                                <h3 class="mb-0">
                                <a href="#" class="btn btn-header-link" data-toggle="collapse" data-target="#faq1" aria-expanded="true" aria-controls="faq1">How do Promotional SMS services help businesses grow?</a>
                                    </h3>
                            </div>

                            <div id="faq1" class="collapse show" aria-labelledby="faqhead1" data-parent="#faq">
                                <div class="card-body">
                                They enable instant outreach, helping you boost engagement, increase conversions, and drive traffic during sales or launches.
                                </div>
                            </div>
                        </div>
                        <!-- Faq 2-->
                        <div class="card">
                            <div class="card-header" id="faqhead2">
                                <h3 class="mb-0">
                                <a href="#" class="btn btn-header-link collapsed" data-toggle="collapse" data-target="#faq2" aria-expanded="true" aria-controls="faq2">Can Promotional SMS be used for sending offers and discounts?</a>
                                </h3>
                            </div>

                            <div id="faq2" class="collapse" aria-labelledby="faqhead2" data-parent="#faq">
                                <div class="card-body">
                                Yes, it’s the best tool to broadcast deals, limited-time offers, and event-based discounts to a wide audience quickly.
                                </div>
                            </div>
                        </div>
                        <!-- Faq 3-->
                        <div class="card">
                            <div class="card-header" id="faqhead3">
                                <h3 class="mb-0">
                                <a href="#" class="btn btn-header-link collapsed" data-toggle="collapse" data-target="#faq3" aria-expanded="true" aria-controls="faq3">Are there any restrictions on Promotional SMS timings?</a>
                                </h3>
                            </div>

                            <div id="faq3" class="collapse" aria-labelledby="faqhead3" data-parent="#faq">
                                <div class="card-body">
                                Yes, Promotional SMS can typically only be sent between 9 AM and 9 PM, as per telecom regulations in many regions.
                                </div>
                            </div>
                        </div>
                        <!-- Faq 4-->
                        <div class="card">
                            <div class="card-header" id="faqhead4">
                                <h3 class="mb-0">
                                <a href="#" class="btn btn-header-link collapsed" data-toggle="collapse" data-target="#faq4" aria-expanded="true" aria-controls="faq4">Is it possible to personalize messages in Promotional SMS campaigns?</a>
                                </h3>
                            </div>

                            <div id="faq4" class="collapse" aria-labelledby="faqhead4" data-parent="#faq">
                                <div class="card-body">
                                Absolutely! You can add customer names or custom details to make each SMS more engaging and targeted.
                                </div>
                            </div>
                        </div>
                        <!-- Faq 5-->
                        <div class="card">
                            <div class="card-header" id="faqhead5">
                                <h3 class="mb-0">
                                <a href="#" class="btn btn-header-link collapsed" data-toggle="collapse" data-target="#faq5" aria-expanded="true" aria-controls="faq5">How does VoIPTech Solutions ensure timely delivery of Promotional SMS?</a>
                                    </h3>
                            </div>

                            <div id="faq5" class="collapse" aria-labelledby="faqhead5" data-parent="#faq">
                                <div class="card-body">
                                We use high-priority routes and a robust delivery engine to ensure your messages are delivered in seconds.
                                </div>
                            </div>
                        </div>
                        <!-- Faq 6-->
                        <div class="card">
                            <div class="card-header" id="faqhead6">
                                <h3 class="mb-0">
                                <a href="#" class="btn btn-header-link collapsed" data-toggle="collapse" data-target="#faq6" aria-expanded="true" aria-controls="faq6">Are delivery reports available for all sent Promotional SMS?</a>
                                </h3>
                            </div>

                            <div id="faq6" class="collapse" aria-labelledby="faqhead6" data-parent="#faq">
                                <div class="card-body">
                                Yes, real-time delivery reports are provided to help track success and optimize your campaign.
                                </div>
                            </div>
                        </div>
                        <!-- Faq 7-->
                        <div class="card">
                            <div class="card-header" id="faqhead7">
                                <h3 class="mb-0">
                                <a href="#" class="btn btn-header-link collapsed" data-toggle="collapse" data-target="#faq7" aria-expanded="true" aria-controls="faq7">How quickly can businesses get started with Promotional SMS?</a>
                                </h3>
                            </div>

                            <div id="faq7" class="collapse" aria-labelledby="faqhead7" data-parent="#faq">
                                <div class="card-body">
                                VoIPTech Solutions enables setup and activation within hours, so you can launch campaigns the same day.
                                </div>
                            </div>
                        </div>
                        <!-- Faq 8-->
                        <div class="card">
                            <div class="card-header" id="faqhead8">
                                <h3 class="mb-0">
                                <a href="#" class="btn btn-header-link collapsed" data-toggle="collapse" data-target="#faq8" aria-expanded="true" aria-controls="faq8">How is Promotional SMS different from other types of Bulk SMS campaigns?</a>
                                </h3>
                            </div>
                        ...
                        <div class="card">
                            <div class="card-header" id="faqhead9">
                                <h3 class="mb-0">
                                <a href="#" class="btn btn-header-link collapsed" data-toggle="collapse" data-target="#faq9" aria-expanded="true" aria-controls="faq9">Are there any hidden charges in VoIPTech's Promotional SMS plans?</a>
                                </h3>
                            </div>
                        ...
                        <div class="card">
                            <div class="card-header" id="faqhead10">
                                <h3 class="mb-0">
                                <a href="#" class="btn btn-header-link collapsed" data-toggle="collapse" data-target="#faq10" aria-expanded="true" aria-controls="faq10">Can Promotional SMS be scheduled in advance?</a>
                                </h3>
                            </div>

                            <div id="faq10" class="collapse" aria-labelledby="faqhead10" data-parent="#faq">
                                <div class="card-body">
                                Yes, you can schedule messages for specific dates and times to align with your campaign strategy.
                                </div>
                            </div>
                        </div>
                    </div>
