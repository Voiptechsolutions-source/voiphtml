 ...
 <main>
        ...
        <div class="container">
            ...
            <div class="row flex-column-reverse flex-md-row-reverse align-items-center _feat-box mt-5">
                <div class="col col-md-6">
                    ...
                    <h2><span class="text-orange">Hosted Call Centers</span> with Zero Infrastructure Cost</h2>
                    <div class="_content">
                        <p>Run your call center without physical setup. All you need is an internet connection — access powerful cloud-based tools to manage, scale, and optimize operations at a fraction of traditional cost.</p>
                    </div>
            ...
            <div class="row flex-column-reverse flex-md-row align-items-center _feat-box py-80">
                <div class="col col-md-6">
                    ...
                    <h2>Smart Routing and Real-Time <span class="text-orange">Call Management Tools</span></h2>
                    <div class="_content">
                       
                        <p>Automatically route calls to the right agents, monitor live activity, and manage traffic effortlessly. Our hosted solution ensures your customers always reach the best person—no delays, no confusion.</p>
                    </div>
            ...
            <div class="row flex-column-reverse flex-md-row-reverse align-items-center _feat-box">
                <div class="col col-md-6">
                    ...
                    <h2><span class="text-orange">Scalable for Startups</span>, Teams, and Enterprises Alike</h2>
                    <div class="_content">
                        <p>Whether you’re just starting or scaling globally, our hosted call center grows with you. Add agents, features, or integrations without downtime or complex setup—fully flexible and future-ready.</p>
                    </div>
                    <div class="demo-btn mt-4">
                        <a href="#" data-toggle="modal" data-target="#myModalForm" class="btn bg-orange text-white rounded-pill  px-4 text-uppercase">Get Demo</a>
                    </div>
            ...
            <div class="row flex-column-reverse flex-md-row align-items-center _feat-box">
                <div class="col col-md-6">
                    <!-- <p class="text-orange">Tailored Communication Solutions</p> -->
                    <h2><span class="text-orange">24/7 Support</span> with Secure, Reliable Cloud Infrastructure</h2>
                    <div class="_content">
                        <p>Your communication backbone is in safe hands. Get enterprise-grade security, automatic backups, and round-the-clock expert support—so your call center never goes down, even when demand peaks.</p>
                    </div>
                    <div class="demo-btn mt-4">
                        <a href="#" data-toggle="modal" data-target="#myModalForm" class="btn bg-orange text-white rounded-pill  px-4 text-uppercase">Get Demo</a>
                    </div>
    ...
    <section class="cta ">
        <div class="container py-5 bg-orange rounded-xl">
            <p class="text-center">Struggling to Manage Calls</p>
            <h2 class="text-center">Without Proper Hosted Call Center Setup?</h2>
            ...
            <div class="row align-items-center">
                <div class="col-12 col-lg-6">
                    <div class="section-title text-center">
                        <h2 class="text-orange">Cloud Control</h2>
                    </div>
                </div>
                <div class="col-12 col-lg-6">
            ...
            <div class="row text-center">
                <div class="col-12 col-lg-4">
                    <div class="solution-box">
                        ...
                        <div class="title">Cloud Simplicity</div>
                        <div class="desc">
                            <p>Launch, manage, and scale your call center—all without on-site hardware.</p>
                        </div>
                    </div>
                </div>
                <div class="col-12 col-lg-4">
                    <div class="solution-box">
                        ...
                        <div class="title">Smart Monitoring</div>
                        <div class="desc">
                            <p>Track performance in real time with dashboards, analytics, and live listening.</p>
                        </div>
                    </div>
                </div>
                <div class="col-12 col-lg-4">
                    <div class="solution-box">
                        ...
                        <div class="desc">
                            <p>Stay connected 24/7 with secure, fail-proof cloud infrastructure and backups.</p>
                        </div>
                    </div>
                </div>
            </div>
