    ...
    <div class="container">
        ...
        <div class="row flex-column-reverse flex-md-row align-items-center _feat-box">
            <div class="col col-md-6">
                <h3>Why Choose <span class="text-orange">VoIPTech Solutions</span> For <span class="text-orange">OpenSIPS Development?</span> </h3>
                <div class="_content">
                    <ul class="list2">
                        <li>
        ...
        <div class="row flex-column-reverse flex-md-row-reverse align-items-center _feat-box py-4">
            <div class="col col-md-6">
                <h3>Key Benefits of Choosing <span class="text-orange">Voip Tech Solutions</span> for <span class="text-orange">OpenSIPS Development</span></h3>
                <div class="_content">
                    <ul class="list2">
                        <li>
                            <div class="list-text d-flex flex-column">
