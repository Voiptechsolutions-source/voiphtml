   ...
   <!-- Hero Section -->
        ...
        <div class="container">
            <div class="d-flex justify-content-between flex-column flex-lg-row mt-5 align-items-start banner-content-container">
                ...
                <div class="banner-content">
                    <h1>Smart IVR System Solutions Provider for Call Centers and Enterprises</h1>
                    <p>Let Your IVR Handle the First Hello</p>
                    <div class="banner-feats">
                        <div class="feat-item">
                            ...
                            <div class="_feat">
                                ...
                                <p>Handle customer calls round the clock without live agents.</p>
                            </div>
                        </div>
                        <div class="feat-item">
                            <div class="feat-icn"><img src="assets/images/icons/feat-icn2.png" alt="Cost-Effective Communication" /></div>
                            <div class="_feat">
                                <div class="_feat-head">Efficient Call Routing</div>
                                <p>Direct callers to the right department instantly.</p>
                            </div>
                        </div>
                        <div class="feat-item">
                            <div class="feat-icn"><img src="assets/images/icons/feat-icn3.png" alt="Cost-Effective Communication" /></div>
                            <div class="_feat">
                                <div class="_feat-head">Personalized Caller Experience</div>
                                <p>Greet and guide users with custom messages and menu options.</p>
                            </div>
                        </div>
                        <div class="feat-item">
                            <div class="feat-icn"><img src="assets/images/icons/feat-icn4.png" alt="Cost-Effective Communication" /></div>
                            <div class="_feat">
                                <div class="_feat-head">Reduced Operational Costs</div>
                                <p>Automate repetitive queries and save on human resources.</p>
                            </div>
                        </div>
                        <div class="feat-item">
                            <div class="feat-icn"><img src="assets/images/icons/feat-icn5.png" alt="Cost-Effective Communication" /></div>
                            <div class="_feat">
                                <div class="_feat-head">Scalable & Flexible</div>
                                <p>Easily adapt IVR flows as your business grows.</p>
                            </div>
                        </div>
                        <div class="feat-item">
                            <div class="feat-icn"><img src="assets/images/icons/feat-icn6.png" alt="Cost-Effective Communication" /></div>
                            <div class="_feat">
                                <div class="_feat-head">Quick Setup & Integration</div>
                                <p>Go live fast with smooth integration into your systems.</p>
                            </div>
                        </div>
                    </div>
    ...
    <div class="container">
        ...
        <div class="row flex-column-reverse flex-md-row align-items-center _feat-box">
                    ...
                    <ul class="list2">
                        <li>
                            <div class="list-text d-flex flex-column">
                                <div class="list-heading">Custom IVR Design</div>
                                <p class="mb-0">We build IVR flows tailored to your specific business needs.</p>
                            </div>
                        </li>
                        <li>
                            <div class="list-text d-flex flex-column">
                                <div class="list-heading">Multi-Level Menu Support</div>
                                <p class="mb-0">Add multiple call options to guide users effectively.</p>
                            </div>  
                        </li>
                        <li>
                            <div class="list-text d-flex flex-column">
                                <div class="list-heading">CRM & API Integration</div>
                                <p class="mb-0">Connect IVR with your CRM or backend for seamless automation.</p>
                            </div>  
                        </li>
                        <li>
                            <div class="list-text d-flex flex-column">
                                <div class="list-heading">Multilingual Options</div>
                                <p class="mb-0">Engage callers in their preferred language.</p>
                            </div>  
                        </li>
                        <li>
                            <div class="list-text d-flex flex-column">
                                <div class="list-heading">Real-Time Call Analytics</div>
                                <p class="mb-0">Monitor IVR performance and customer interactions.</p>
                            </div>  
                        </li>
                        <li>
                            <div class="list-text d-flex flex-column">
                                <div class="list-heading">Cloud-Based Deployment</div>
                                <p class="mb-0">Flexible and reliable IVR hosted on secure cloud servers.</p>
                            </div>  
                        </li>
                        <li>
                            <div class="list-text d-flex flex-column">
                                <div class="list-heading">DTMF & Voice Recognition Support</div>
                                <p class="mb-0">Let users interact via keypress or speech.</p>
                            </div>  
                        </li>
                        <li>
                            <div class="list-text d-flex flex-column">
                                <div class="list-heading">Fast Turnaround Time</div>
                                <p class="mb-0">Get your IVR up and running in minimal time.</p>
                            </div>  
                        </li>
            ...
            <div class="col col-md-6">
                <div class="feat-img">
                    <img src="assets/images/ivr-solution1.svg" alt="Why Choose VoIPTech For CC Traffic? " class="img-fluid" loading="lazy" />
                </div>
            </div>
        </div>
        <!-- Faet 2 -->
        <div class="row flex-column-reverse flex-md-row-reverse align-items-center _feat-box py-4">
            <div class="col col-md-6">
                ...
                <div class="_content">
                    <ul class="list2">
                        <li>
                            <div class="list-text d-flex flex-column">
                                <div class="list-heading">Tailored Experience</div>
                                <p class="mb-0">We build IVRs around your goals, not generic templates.</p>
                            </div>
                        </li>
                        <li>
                            <div class="list-text d-flex flex-column">
                                <div class="list-heading">Better First-Call Resolution</div>
                                <p class="mb-0">Smart routing ensures customer issues are handled quickly.</p>
                            </div>  
                        </li>
                        <li>
                            <div class="list-text d-flex flex-column">
                                <div class="list-heading">Boost in Productivity</div>
                                <p class="mb-0">Your team handles fewer repetitive calls, focusing on core work.</p>
                            </div>  
                        </li>
                        <li>
                            <div class="list-text d-flex flex-column">
                                <div class="list-heading">Enhanced Customer Satisfaction</div>
                                <p class="mb-0">Fast, guided responses lead to happier customers.</p>
                            </div>  
                        </li>
                        <li>
                            <div class="list-text d-flex flex-column">
                                <div class="list-heading">Reliable System Uptime</div>
                                <p class="mb-0">Our IVRs stay live, even during high call volumes.</p>
                            </div>  
                        </li>
                        <li>
                            <div class="list-text d-flex flex-column">
                                <div class="list-heading">Affordable Pricing Plans</div>
                                <p class="mb-0">Choose plans that match your usage and budget.</p>
                            </div>  
                        </li>
                    </ul>
                </div>
            ...
            <div class="col col-md-6">
                <div class="feat-img">
                    <img src="assets/images/ivr-solution2.svg" alt="Key Benefits of Choosing Voip Tech Solutions for IVR System Solutions" class="img-fluid" loading="lazy" />
                </div>
            </div>
        </div>
        <!-- Faet 3 -->
        <div class="row flex-column-reverse flex-md-row align-items-center _feat-box py-4">
            <div class="col col-md-6">
                ...
                <div class="_content">
                    ...
                    <ul class="list2 ">
                        <li>
                            <div class="list-text d-flex flex-column">
                                <div class="list-heading">Step 1: Customer Calls In</div>
                                <p class="mb-0">Caller reaches your business number integrated with our IVR system.</p>
                            </div>
                        </li>
                        <li>
                            <div class="list-text d-flex flex-column">
                                <div class="list-heading">Step 2: IVR Menu Is Played</div>
                                <p class="mb-0">A custom voice menu guides the caller with easy-to-follow options.</p>
                            </div>
                        </li>
                        <li>
                            <div class="list-text d-flex flex-column">
                                <div class="list-heading">Step 3: Input Is Collected</div>
                                <p class="mb-0">The system captures keypad input or voice commands from the caller.</p>
                            </div>
                        </li>
                        <li>
                            <div class="list-text d-flex flex-column">
                                <div class="list-heading">Step 4: Call Is Routed Smartly</div>
                                <p class="mb-0">Based on the input, the call is routed to the right department or action.</p>
                            </div>
                        </li>
                        <li>
                            <div class="list-text d-flex flex-column">
                                <div class="list-heading">Step 5: Resolution or Action</div>
                                <p class="mb-0">The issue is resolved through automation or passed to the right agent.</p>
                            </div>
                        </li>
            ...
            <div class="col col-md-6">
                <div class="feat-img">
                    <img src="assets/images/ivr-solution3.svg" alt="How VoIPTech Solutions IVR System Works" class="img-fluid" loading="lazy" />
                </div>
            </div>
        </div>
        ...
        <div class="row flex-column-reverse flex-md-row-reverse align-items-center _feat-box">
                    ...
                    <ul class="list2 icons-list">
                        <li>
                            ...
                            <div class="list-text d-flex flex-column">
                                ...
                                <p class="mb-0">Handle high-volume support with automated order tracking and returns.</p>
                            </div>
                        </li>
                        <li>
                            <span class="_icn">🏥</span>
                            <div class="list-text d-flex flex-column">
                                ...
                                <p class="mb-0">Automated appointment booking, lab result access, and patient reminders made easy.</p>
                            </div>  
                        </li>
                        <li>
                            <span class="_icn">🏦 </span>
                            <div class="list-text d-flex flex-column">
                                ...
                                <p class="mb-0">Streamline customer queries, reduce wait times, and ensure secure self-service.</p>
                            </div>  
                        </li>
                        <li>
                            <span class="_icn">🏫</span>
                            <div class="list-text d-flex flex-column">
                                ...
                                <p class="mb-0">Distribute important notices, class schedules, and admission updates effortlessly.</p>
                            </div>  
                        </li>
                        <li>
                            <span class="_icn">🏢</span>
                            <div class="list-text d-flex flex-column">
                                ...
                                <p class="mb-0">Ensure every department has a dedicated, automated response channel.</p>
                            </div>  
                        </li>
                        <li>
                            <span class="_icn">🚚</span>
                            <div class="list-text d-flex flex-column">
                                ...
                                <p class="mb-0">Offer shipment tracking, delivery updates, and on-the-go support.</p>
                            </div>  
                        </li>
                        <li>
                            <span class="_icn">🏨</span>
                            <div class="list-text d-flex flex-column">
                                ...
                                <p class="mb-0">Simplify bookings, check-ins, and customer requests with IVR integration.</p>
                            </div>  
                        </li>
            ...
            <div class="col col-md-6">
                <div class="feat-img">
                    <img src="assets/images/ivr-solution4.svg" alt="Industries We Serve" class="img-fluid" loading="lazy" />
                </div>
            </div>
        </div>
            ...
            <div class="process-box-cont">
                <div class="process-box">
                    <div class="process-body">
                        ...
                        <div class="_pro-content">
                            ...
                            <p>Reach out via our contact form, email, or phone to share your IVR requirements.</p>
                        </div>
                    </div>
                ...
                <div class="process-box">
                    <div class="process-body">
                        ...
                        <div class="_pro-content">
                            <h3>Choose Your IVR Configuration</h3>
                            <p>Pick from a pre-built flow or request a custom setup based on your business needs.</p>
                        </div>
                    </div>
                    <div class="process-arrow">
                        <img src="assets/images/process-arrow.png" alt="Process Arrow" loading="lazy" />
                ...
                <div class="process-box">
                    <div class="process-body">
                        ...
                        <div class="_pro-content">
                            ...
                            <p>We’ll deploy and test the IVR system quickly so you can start managing calls effectively — often within hours!</p>
                        </div>
                    </div>
                    <div class="process-arrow">
                        <img src="assets/images/process-arrow.png" alt="Process Arrow" loading="lazy" />
