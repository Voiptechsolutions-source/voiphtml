...
<head>
    ...
    <link rel="stylesheet" href="assets/css/newstyle.css?v=1.008">
    ...
    <div class="container">
        ...
        <div class="row flex-column-reverse flex-md-row align-items-center _feat-box">
            <div class="col col-md-6">
                <h3>Why <span class="text-orange">VoIP Tech Solutions</span> Is the Smart Choice for <span class="text-orange">Modern Communication</span></h3>
                <div class="_content">
                    <ul class="list2">
                        <li>
                            <div class="list-text d-flex flex-column">
                                <div class="list-heading">24/7 Expert Support</div>
                                <p class="mb-0">Our experts ensure instant activation & round-the-clock assistance.</p>
                            </div>
                        </li>
                        <li>
                            <div class="list-text d-flex flex-column">
                                <div class="list-heading">Crystal-Clear Voice Quality</div>
                                <p class="mb-0">Enjoy HD VoIP calls with zero interruptions.</p>
                            </div>  
                        </li>
                        <li>
                            <div class="list-text d-flex flex-column">
                                <div class="list-heading">Flexible Plans</div>
                                <p class="mb-0">Choose from prepaid VoIP minutes or postpaid billing.</p>
                            </div>  
                        </li>
                        <li>
                            <div class="list-text d-flex flex-column">
                                <div class="list-heading">Global Coverage</div>
                                <p class="mb-0">Buy VoIP minutes for international calls across 150+ destinations.</p>
                            </div>  
                        </li>
                        <li>
                            <div class="list-text d-flex flex-column">
                                <div class="list-heading">Unbeatable Pricing</div>
                                <p class="mb-0">Save more with cost-effective VoIP solutions.</p>
                            </div>  
                        </li>
                    </ul>
                </div>
    ...
    <section class="trusted-logos py-60">
       ...
       <section class="customer-testim py-80">
        <div class="container position-relative">
            ...
            <h2 class="text-center">What Our Customers Say <span class="text-orange">About Us</span></h2>
        ...
        <div class="container">
            <div class="contact-box-cont">
                <div class="contact-box-header bg-orange text-white p-3">
                    <h2>Have Questions? </h2>
                    <a href="#">Call Now +91 (000)000-0000</a>
                </div>
                        ...
                        <div class="accordion" id="faq">
                            <div class="card">
                                <div class="card-header" id="faqhead1">
                                    ...
                                    aria-expanded="true" aria-controls="faq1">What is Bulk SMS, and how can it help my business?</a>
                                </div>

                                <div id="faq1" class="collapse show" aria-labelledby="faqhead1" data-parent="#faq">
                                    <div class="card-body">
                                        With our SMS marketing solutions, you get real-time delivery reports, open rate tracking, and campaign analytics to measure engagement and conversions. Our advanced reporting tools help you optimize future campaigns for better reach and ROI.  With our SMS marketing solutions, you get real-time delivery reports, open rate tracking, and campaign analytics to measure engagement and conversions. Our advanced reporting tools help you optimize future campaigns for better reach and ROI.
With our SMS marketing solutions, you get real-time delivery reports, open rate tracking, and campaign analytics to measure engagement and conversions. Our advanced reporting tools help you optimize future campaigns for better reach and ROI.
                                    </div>
                                </div>
                            </div>
                            <div class="card">
                                <div class="card-header" id="faqhead2">
                                    ...
                                    aria-expanded="true" aria-controls="faq2">How does Two-Way SMS improve customer engageme</a>
                                </div>
                            ...
                            <div class="card">
                                <div class="card-header" id="faqhead3">
                                    ...
                                    aria-expanded="true" aria-controls="faq3">How do I track SMS campaign performance?</a>
                                </div>
