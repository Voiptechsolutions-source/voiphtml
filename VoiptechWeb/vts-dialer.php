   ...
   <!-- Hero Section -->
        ...
        <div class="container">
            <div class="d-flex justify-content-between flex-column flex-lg-row mt-5 align-items-start banner-content-container">
                ...
                <div class="banner-content">
                    <h1>Custom VTS Dialer Solution Provider for Businesses & Call Centers</h1>
                    <p>Power Your Contact Center with Precision & Performance</p>
                    <div class="banner-feats">
                        <div class="feat-item">
                            <div class="feat-icn"><img src="assets/images/icons/feat-icn1.png" alt="Cost-Effective Communication" /></div>
                            <div class="_feat">
                                <div class="_feat-head">Custom-Built for Your Business</div>
                                <p>Designed to match your unique needs.</p>
                            </div>
                        </div>
                        <div class="feat-item">
                            <div class="feat-icn"><img src="assets/images/icons/feat-icn2.png" alt="Cost-Effective Communication" /></div>
                            <div class="_feat">
                                <div class="_feat-head">Feature-Rich & Future-Ready</div>
                                <p>Packed with 50+ advanced tools.</p>
                            </div>
                        </div>
                        <div class="feat-item">
                            <div class="feat-icn"><img src="assets/images/icons/feat-icn3.png" alt="Cost-Effective Communication" /></div>
                            <div class="_feat">
                                <div class="_feat-head">Improved Agent Productivity</div>
                                <p>Boosts performance with automation.</p>
                            </div>
                        </div>
                        <div class="feat-item">
                            <div class="feat-icn"><img src="assets/images/icons/feat-icn4.png" alt="Cost-Effective Communication" /></div>
                            <div class="_feat">
                                <div class="_feat-head">Advanced Analytics & Reporting</div>
                                <p>Clear insights with visual reports.</p>
                            </div>
                        </div>
                        <div class="feat-item">
                            <div class="feat-icn"><img src="assets/images/icons/feat-icn5.png" alt="Cost-Effective Communication" /></div>
                            <div class="_feat">
                                <div class="_feat-head">Seamless Integrations</div>
                                <p>Connects with CRM, ePBX, and more.</p>
                            </div>
                        </div>
                        <div class="feat-item">
                            <div class="feat-icn"><img src="assets/images/icons/feat-icn6.png" alt="Cost-Effective Communication" /></div>
                            <div class="_feat">
                                <div class="_feat-head">Unmatched Support & Security</div>
                                <p>Secure and supported 24/7.</p>
                            </div>
                        </div>
                    </div>
    ...
    <div class="container">
        ...
        <div class="row flex-column-reverse flex-md-row align-items-center _feat-box">
                    ...
                    <ul class="list2">
                        <li>
                            <div class="list-text d-flex flex-column">
                                <div class="list-heading">Tailor-Made Dialer Solution</div>
                                <p class="mb-0">Custom-built to fit your unique call center or business needs.</p>
                            </div>
                        </li>
                        <li>
                            <div class="list-text d-flex flex-column">
                                <div class="list-heading">Smartphone & App Integration</div>
                                <p class="mb-0">Stay connected and manage calls from anywhere via mobile apps.</p>
                            </div>  
                        </li>
                        <li>
                            <div class="list-text d-flex flex-column">
                                <div class="list-heading">Unified Agent Desktop</div>
                                <p class="mb-0">Give agents everything they need on a single screen for efficiency.</p>
                            </div>  
                        </li>
                        <li>
                            <div class="list-text d-flex flex-column">
                                <div class="list-heading">Multi-Level IVRS Support</div>
                                <p class="mb-0">Create interactive and layered IVRs to streamline inbound queries.</p>
                            </div>  
                        </li>
                        <li>
                            <div class="list-text d-flex flex-column">
                                <div class="list-heading">Whisper, Barge-in & Call Snooping</div>
                                <p class="mb-0">Train agents in real-time without disrupting customer experience.</p>
                            </div>  
                        </li>
                        <li>
                            <div class="list-text d-flex flex-column">
                                <div class="list-heading">Call Scoring & Coaching Tools</div>
                                <p class="mb-0">Improve performance with built-in evaluation and coaching modules.</p>
                            </div>  
                        </li>
                        <li>
                            <div class="list-text d-flex flex-column">
                                <div class="list-heading">Real-Time Call Monitoring</div>
                                <p class="mb-0">Track live calls, bandwidth, and system stats from one dashboard.</p>
                            </div>  
                        </li>
                        <li>
                            <div class="list-text d-flex flex-column">
                                <div class="list-heading">Secure Web Interface</div>
                                <p class="mb-0">High-level security with role-based access and encrypted data.</p>
                            </div>  
                        </li>
                        <li>
                            <div class="list-text d-flex flex-column">
                                <div class="list-heading">Cloud & On-Premise Deployment</div>
                                <p class="mb-0">Choose your preferred hosting setup without compromising features.</p>
                            </div>  
                        </li>
                        <li>
                            <div class="list-text d-flex flex-column">
                                <div class="list-heading">Multi-language Support</div>
                                <p class="mb-0">Cater to diverse customers with multilingual interface options.</p>
                            </div>  
                        </li>
            ...
            <div class="col col-md-6">
                <div class="feat-img">
                    <img src="assets/images/vts-dialer1.svg" alt="Why Choose VTS Dialer Solutions For Your Business?" class="img-fluid" loading="lazy" />
                </div>
            </div>
        </div>
        <!-- Faet 2 -->
        <div class="row flex-column-reverse flex-md-row-reverse align-items-center _feat-box py-4">
            <div class="col col-md-6">
                ...
                <div class="_content">
                    <ul class="list2">
                        <li>
                            <div class="list-text d-flex flex-column">
                                <div class="list-heading">Enhanced Agent Efficiency</div>
                                <p class="mb-0">Empower agents with automation, quick access, and intuitive features.</p>
                            </div>
                        </li>
                        <li>
                            <div class="list-text d-flex flex-column">
                                <div class="list-heading">Reduced Communication Costs</div>
                                <p class="mb-0">Enjoy affordable international and local calling through VoIP optimization.</p>
                            </div>  
                        </li>
                        <li>
                            <div class="list-text d-flex flex-column">
                                <div class="list-heading">Real-Time Analytics</div>
                                <p class="mb-0">Track call performance and user behavior through live insights and reports.</p>
                            </div>  
                        </li>
                        <li>
                            <div class="list-text d-flex flex-column">
                                <div class="list-heading">Seamless CRM Integration</div>
                                <p class="mb-0">Connect your dialer with top CRMs for better customer management.</p>
                            </div>  
                        </li>
                        <li>
                            <div class="list-text d-flex flex-column">
                                <div class="list-heading">Scalable & Customizable</div>
                                <p class="mb-0">Scale up with ease and tailor features to match your business goals.</p>
                            </div>  
                        </li>
                        <li>
                            <div class="list-text d-flex flex-column">
                                <div class="list-heading">Reliable Support</div>
                                <p class="mb-0">Get round-the-clock expert support and regular system enhancements.</p>
                            </div>  
                        </li>
                    </ul>
                </div>
            ...
            <div class="col col-md-6">
                <div class="feat-img">
                    <img src="assets/images/vts-dialer2.svg" alt="Key Benefits of Choosing Voip Tech Solutions for VTS Dialer" class="img-fluid" loading="lazy" />
                </div>
            </div>
        </div>
        <!-- Faet 3 -->
        <div class="row flex-column-reverse flex-md-row align-items-center _feat-box py-4">
            <div class="col col-md-6">
                ...
                <div class="_content">
                    ...
                    <ul class="list2 ">
                        <li>
                            <div class="list-text d-flex flex-column">
                                <div class="list-heading">Step 1: Agent Logs into VTS Dialer</div>
                                <p class="mb-0">Agents sign in via a secure web interface or mobile app with personalized access credentials.</p>
                            </div>
                        </li>
                        <li>
                            <div class="list-text d-flex flex-column">
                                <div class="list-heading">Step 2: CRM Auto Pop-Up on Incoming Call</div>
                                <p class="mb-0">When a call is connected, the system automatically pulls up customer data from the integrated CRM.</p>
                            </div>
                        </li>
                        <li>
                            <div class="list-text d-flex flex-column">
                                <div class="list-heading">Step 3: Dialer Initiates or Receives Calls</div>
                                <p class="mb-0">Supports manual, predictive, and progressive dialing for outbound, and smart call routing for inbound.</p>
                            </div>
                        </li>
                        <li>
                            <div class="list-text d-flex flex-column">
                                <div class="list-heading">Step 4: Real-Time Monitoring & Controls</div>
                                <p class="mb-0">Supervisors can barge-in, whisper, snoop, or monitor performance through live dashboards and reports.</p>
                            </div>
                        </li>
                        <li>
                            <div class="list-text d-flex flex-column">
                                <div class="list-heading">Step 5: Data Sync & Reporting</div>
                                <p class="mb-0">Every interaction is logged with detailed call analytics, enabling post-call actions and campaign refinements.</p>
                            </div>
                        </li>
            ...
            <div class="col col-md-6">
                <div class="feat-img">
                    <img src="assets/images/vts-dialer3.svg" alt="How VoIPTech Solutions VTS Dialer Works" class="img-fluid" loading="lazy" />
                </div>
            </div>
        </div>
        ...
        <div class="row flex-column-reverse flex-md-row-reverse align-items-center _feat-box">
                    ...
                    <ul class="list2 icons-list">
                        <li>
                            ...
                            <div class="list-text d-flex flex-column">
                                ...
                                <p class="mb-0">Boost agent productivity and customer satisfaction.</p>
                            </div>
                        </li>
                        <li>
                            <span class="_icn">🏥</span>
                            <div class="list-text d-flex flex-column">
                                ...
                                <p class="mb-0">Streamline appointment reminders and patient communication.</p>
                            </div>  
                        </li>
                        <li>
                            <span class="_icn">🏛 </span>
                            <div class="list-text d-flex flex-column">
                                ...
                                <p class="mb-0">Ensure prompt citizen engagement and support.</p>
                            </div>  
                        </li>
                        <li>
                            <span class="_icn">🏫</span>
                            <div class="list-text d-flex flex-column">
                                ...
                                <p class="mb-0">Enhance student engagement and admission follow-ups.</p>
                            </div>  
                        </li>
                        <li>
                            <span class="_icn">💰</span>
                            <div class="list-text d-flex flex-column">
                                ...
                                <p class="mb-0">Improve client interactions with secure, efficient calling.</p>
                            </div>  
                        </li>
                        <li>
                            <span class="_icn">🛒</span>
                            <div class="list-text d-flex flex-column">
                                ...
                                <p class="mb-0">Manage orders, support, and feedback effortlessly.</p>
                            </div>  
                        </li>
                        <li>
                            <span class="_icn">🚗</span>
                            <div class="list-text d-flex flex-column">
                                ...
                                <p class="mb-0">Handle service reminders and lead follow-ups with ease.</p>
                            </div>  
                        </li>
                        <li>
                            <span class="_icn">📺</span>
                            <div class="list-text d-flex flex-column">
                                ...
                                <p class="mb-0">Coordinate campaigns, promotions, and support efficiently.</p>
                            </div>  
                        </li>
            ...
            <div class="col col-md-6">
                <div class="feat-img">
                    <img src="assets/images/vts-dialer4.svg" alt="Industries We Serve" class="img-fluid" loading="lazy" />
                </div>
            </div>
        </div>
            ...
            <div class="process-box-cont">
                <div class="process-box">
                    <div class="process-body">
                        ...
                        <div class="_pro-content">
                            ...
                            <p>Contact us via form, email, or call.</p>
                        </div>
                    </div>
                ...
                <div class="process-box">
                    <div class="process-body">
                        ...
                        <div class="_pro-content">
                            <h3>Choose Your VTS Configuration</h3>
                            <p>Schedule a quick consultation & demo.</p>
                        </div>
                    </div>
                    <div class="process-arrow">
                        <img src="assets/images/process-arrow.png" alt="Process Arrow" loading="lazy" />
                ...
                <div class="process-box">
                    <div class="process-body">
                        ...
                        <div class="_pro-content">
                            <h3>Go Live with Your IVR</h3>
                            <p>Get a tailored VTS Dialer setup ready to launch</p>
                        </div>
                    </div>
                    <div class="process-arrow">
                        <img src="assets/images/process-arrow.png" alt="Process Arrow" loading="lazy" />
