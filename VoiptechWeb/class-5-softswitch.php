        ...
        <div class="container">
            <div class="d-flex justify-content-between flex-column flex-lg-row mt-5 align-items-start banner-content-container">
                ...
                <div class="banner-content">
                    <h1>Reliable Class 5 Softswitch Solutions for Service Providers & VoIP Networks</h1>
                    <p>Powering VoIP services, effortlessly</p>
                    <div class="banner-feats">
                        <div class="feat-item">
                            <div class="feat-icn"><img src="assets/images/icons/feat-icn1.png" alt="Cost-Effective Communication" /></div>
                            <div class="_feat">
                                <div class="_feat-head">Cost Optimization</div>
                                <p>Maximize profitability by reducing termination and routing costs.</p>
                            </div>
                        </div>
                        <div class="feat-item">
                            <div class="feat-icn"><img src="assets/images/icons/feat-icn2.png" alt="Cost-Effective Communication" /></div>
                            <div class="_feat">
                                <div class="_feat-head">Seamless Call Handling</div>
                                <p>Support high-quality, high-volume direct calls.</p>
                            </div>
                        </div>
                        <div class="feat-item">
                            <div class="feat-icn"><img src="assets/images/icons/feat-icn3.png" alt="Cost-Effective Communication" /></div>
                            <div class="_feat">
                                <div class="_feat-head">User-Friendly Interface</div>
                                <p>Easy-to-use platform for service configuration and management.</p>
                            </div>
                        </div>
                        <div class="feat-item">
                            <div class="feat-icn"><img src="assets/images/icons/feat-icn4.png" alt="Cost-Effective Communication" /></div>
                            <div class="_feat">
                                <div class="_feat-head">Advanced Billing Features</div>
                                <p>Real-time billing with flexible rate plans and prepaid/postpaid models.</p>
                            </div>
                        </div>
                        <div class="feat-item">
                            ...
                            <div class="_feat">
                                ...
                                <p>Effortlessly scale to support millions of users or calls.</p>
                            </div>
                        </div>
                        <div class="feat-item">
                            <div class="feat-icn"><img src="assets/images/icons/feat-icn6.png" alt="Cost-Effective Communication" /></div>
                            <div class="_feat">
                                <div class="_feat-head">Reliable Network Security</div>
                                <p>State-of-the-art fraud detection and secure routing.</p>
                            </div>
                        </div>
                    </div>
    ...
    <div class="container">
        ...
        <div class="row flex-column-reverse flex-md-row align-items-center _feat-box">
            <div class="col col-md-6">
                <h2>Why Choose <span class="text-orange">VoIPTech Solutions </span> For <span class="text-orange">Class 5 Softswitch?</span> </h2>
                <div class="_content">
                    <ul class="list2">
                        <li>
                            <div class="list-text d-flex flex-column">
                                <div class="list-heading">Prepaid/Postpaid Billing</div>
                                <p class="mb-0">Custom billing models to fit both consumer and business needs.</p>
                            </div>
                        </li>
                        <li>
                            <div class="list-text d-flex flex-column">
                                <div class="list-heading">High Call Quality</div>
                                <p class="mb-0">Ensure clear and reliable calls across global networks.</p>
                            </div>  
                        </li>
                        <li>
                            <div class="list-text d-flex flex-column">
                                <div class="list-heading">Dynamic Routing Rules</div>
                                <p class="mb-0">Define specific routing based on traffic type, cost, and quality.</p>
                            </div>  
                        </li>
                        <li>
                            <div class="list-text d-flex flex-column">
                                <div class="list-heading">End-User Management Portal</div>
                                <p class="mb-0">Empower users to manage their own accounts, subscriptions, and preferences.</p>
                            </div>  
                        </li>
                        <li>
                            <div class="list-text d-flex flex-column">
                                <div class="list-heading">Multi-Protocol Support</div>
                                <p class="mb-0">Supports a wide range of VoIP protocols including SIP, H.323, and more.</p>
                            </div>  
                        </li>
                        <li>
                            <div class="list-text d-flex flex-column">
                                <div class="list-heading">Fraud Prevention</div>
                                <p class="mb-0">Includes advanced features to detect and prevent fraudulent calls.</p>
                            </div>  
                        </li>
                        <li>
                            <div class="list-text d-flex flex-column">
                                <div class="list-heading">Real-Time Monitoring</div>
                                <p class="mb-0">Get live data on call performance, system health, and user activity.</p>
                            </div>  
                        </li>
                        <li>
                            <div class="list-text d-flex flex-column">
                                <div class="list-heading">Multi-Level IVR</div>
                                <p class="mb-0">Create interactive voice response systems with layered menus.</p>
                            </div>  
                        </li>
                        <li>
                            <div class="list-text d-flex flex-column">
                                <div class="list-heading">Global Coverage</div>
                                <p class="mb-0">Support for international calling and roaming services.</p>
                            </div>  
                        </li>
                        <li>
                            <div class="list-text d-flex flex-column">
                                <div class="list-heading">Dedicated Technical Support</div>
                                <p class="mb-0">24/7 access to VoIP experts for support and troubleshooting.</p>
                            </div>  
                        </li>
                    </ul>
                </div>
            ...
            <div class="col col-md-6">
                <div class="feat-img">
                    <img src="assets/images/class5-solution1.svg" alt="Why Choose VoipTechr Solutions For Class 4 Softswitch?" class="img-fluid" loading="lazy" />
                </div>
            </div>
        </div>
        <!-- Faet 2 -->
        <div class="row flex-column-reverse flex-md-row-reverse align-items-center _feat-box py-4">
            <div class="col col-md-6">
                <h2>Key Benefits of Choosing <span class="text-orange">VoIPTech Solutions</span> for <span class="text-orange">Class 5 Softswitch</span></h2>
                <div class="_content">
                    <ul class="list2">
                        <li>
                            <div class="list-text d-flex flex-column">
                                <div class="list-heading">Profit Maximization</div>
                                <p class="mb-0">Cut costs with intelligent call routing while increasing revenue with flexible billing.</p>
                            </div>
                        </li>
                        <li>
                            <div class="list-text d-flex flex-column">
                                <div class="list-heading">Scalable for Growing Networks</div>
                                <p class="mb-0">Add users, routes, or services easily as your needs expand.</p>
                            </div>  
                        </li>
                        <li>
                            <div class="list-text d-flex flex-column">
                                <div class="list-heading">Easy Integration</div>
                                <p class="mb-0">Quick integration with existing infrastructure, including SIP servers and databases.</p>
                            </div>  
                        </li>
                        <li>
                            <div class="list-text d-flex flex-column">
                                <div class="list-heading">Self-Service for End-Users</div>
                                <p class="mb-0">Users can control their settings, reducing administrative overhead.</p>
                            </div>  
                        </li>
                        <li>
                            <div class="list-text d-flex flex-column">
                                <div class="list-heading">Enhanced Security</div>
                                <p class="mb-0">Protect your network with built-in fraud detection, encryption, and traffic filtering.</p>
                            </div>  
                        </li>
                        <li>
                            <div class="list-text d-flex flex-column">
                                <div class="list-heading">Round-the-Clock Support</div>
                                <p class="mb-0">Expert support teams available at all hours to ensure your system runs smoothly.</p>
                            </div>  
                        </li>
                    </ul>
                </div>
            ...
            <div class="col col-md-6">
                <div class="feat-img">
                    <img src="assets/images/class5-solution2.svg" alt="Key Benefits of Choosing Voip Tech Solutions for Class 4 Softswitch" class="img-fluid" loading="lazy" />
                </div>
            </div>
        </div>
        <!-- Faet 3 -->
        <div class="row flex-column-reverse flex-md-row align-items-center _feat-box py-4">
            <div class="col col-md-6">
                <h2>How VoIPTech Solutions <span class="text-orange">Class 5 Softswitch </span>  Works</h2>
                <div class="_content">
                    <p>Our Class 5 Softswitch solution is designed for service providers who need high-volume, direct-to-user VoIP communication. Here’s how it works:</p>
                    <ul class="list2 ">
                        <li>
                            <div class="list-text d-flex flex-column">
                                <div class="list-heading">Step 1: User Account Setup</div>
                                <p class="mb-0">Create and configure user accounts through the intuitive web interface.</p>
                            </div>
                        </li>
                        <li>
                            <div class="list-text d-flex flex-column">
                                <div class="list-heading">Step 2: Call Routing Configuration </div>
                                <p class="mb-0">Set up call routing rules based on destination, cost, or quality.</p>
                            </div>
                        </li>
                        <li>
                            <div class="list-text d-flex flex-column">
                                <div class="list-heading">Step 3: Voice Call Termination</div>
                                <p class="mb-0">Route calls to end users with clear, reliable connections.</p>
                            </div>
                        </li>
                        <li>
                            <div class="list-text d-flex flex-column">
                                <div class="list-heading">Step 4: Billing and Reporting</div>
                                <p class="mb-0">Generate real-time CDRs and manage billing cycles (prepaid/postpaid).</p>
                            </div>
                        </li>
                        <li>
                            <div class="list-text d-flex flex-column">
                                <div class="list-heading">Step 5: Monitor & Optimize</div>
                                <p class="mb-0">Track performance with live dashboards, and make adjustments as needed.</p>
                            </div>
                        </li>
            ...
            <div class="col col-md-6">
                <div class="feat-img">
                    <img src="assets/images/class5-solution3.svg" alt="How VoIPTech Solutions Fusion PBX Works" class="img-fluid" loading="lazy" />
                </div>
            </div>
        </div>
        ...
        <div class="row flex-column-reverse flex-md-row-reverse align-items-center _feat-box">
            <div class="col col-md-6">
                ...
                <div class="_content">
                    <p>VoIPTech Solutions Class 5 Softswitch is perfect for a variety of industries, providing flexible, scalable, and secure VoIP services.</p>
                    <ul class="list2 icons-list">
                        <li>
                            <span class="_icn">📱</span>
                            <div class="list-text d-flex flex-column">
                                <div class="list-heading">VoIP Resellers</div>
                                <p class="mb-0">Offer direct VoIP services to your customers with a robust switching solution.</p>
                            </div>
                        </li>
                        <li>
                            <span class="_icn">🏠 </span>
                            <div class="list-text d-flex flex-column">
                                <div class="list-heading">Residential Providers</div>
                                <p class="mb-0">Serve residential users with affordable and reliable VoIP calls.</p>
                            </div>  
                        </li>
                        <li>
                            <span class="_icn">📞</span>
                            <div class="list-text d-flex flex-column">
                                <div class="list-heading">Business VoIP Providers</div>
                                <p class="mb-0">Support business clients with high-quality voice services.</p>
                            </div>  
                        </li>
                        <li>
                            <span class="_icn">🏢</span>
                            <div class="list-text d-flex flex-column">
                                <div class="list-heading">Telecom Operators</div>
                                <p class="mb-0">Integrate Class 5 Softswitch for better network management and service delivery.</p>
                            </div>  
                        </li>
                        <li>
                            <span class="_icn">🏙️ </span>
                            <div class="list-text d-flex flex-column">
                                <div class="list-heading">Enterprise Communication</div>
                                <p class="mb-0">Enhance internal communication across multiple locations or global offices.</p>
                            </div>  
                        </li>
                        <li>
                            <span class="_icn">🌍</span>
                            <div class="list-text d-flex flex-column">
                                <div class="list-heading">International Calling Services </div>
                                <p class="mb-0">Enable global calling with flexible billing and routing options.</p>
                            </div>  
                        </li>
            ...
            <div class="col col-md-6">
                <div class="feat-img">
                    <img src="assets/images/class5-solution4.svg" alt="Industries We Serve" class="img-fluid" loading="lazy" />
                </div>
            </div>
        </div>
                ...
                <div class="process-box">
                    <div class="process-body">
                        ...
                        <div class="_pro-content">
                            ...
                            <p>Talk to our experts about your specific service needs and VoIP infrastructure.</p>
                        </div>
                    </div>
                ...
                <div class="process-box">
                    <div class="process-body">
                        ...
                        <div class="_pro-content">
                            ...
                            <p>We’ll tailor the Class 5 Softswitch for your traffic volume and user base.</p>
                        </div>
                    </div>
                    <div class="process-arrow">
                        <img src="assets/images/process-arrow.png" alt="Process Arrow" loading="lazy" />
                ...
                <div class="process-box">
                    <div class="process-body">
                        ...
                        <div class="_pro-content">
                            ...
                            <p>Launch your VoIP services with VoIPTech’s full technical support and maintenance.</p>
                        </div>
                    </div>
                    <div class="process-arrow">
                        <img src="assets/images/process-arrow.png" alt="Process Arrow" loading="lazy" />
