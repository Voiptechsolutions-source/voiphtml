        ...
        <div class="container">
            <div class="d-flex justify-content-between flex-column flex-lg-row mt-5 align-items-start banner-content-container">
                ...
                <div class="banner-content">
                    <h1>Trusted IP PBX Solutions Provider for Businesses of All Sizes</h1>
                    <p>Smart IP PBX for Effortless Connectivity</p>
                    <div class="banner-feats">
                        <div class="feat-item">
                            <div class="feat-icn"><img src="assets/images/icons/feat-icn1.png" alt="Cost-Effective Communication" /></div>
                            <div class="_feat">
                                <div class="_feat-head">Reduced Communication Costs</div>
                                <p>Save big on local and international calls.</p>
                            </div>
                        </div>
                        <div class="feat-item">
    ...
    <div class="container">
        ...
        <div class="row flex-column-reverse flex-md-row align-items-center _feat-box">
            <div class="col col-md-6">
                <h2>Why Choose <span class="text-orange">VoIPTech Solutions </span> For <span class="text-orange">IP PBX?</span> </h2>
                <div class="_content">
                    <ul class="list2">
                        <li>
                            <div class="list-text d-flex flex-column">
                                <div class="list-heading">Custom Call Routing</div>
                                <p class="mb-0">Direct calls smartly with flexible routing options.</p>
                            </div>
                        </li>
                        <li>
                            <div class="list-text d-flex flex-column">
                                <div class="list-heading">HD Voice Quality</div>
                                <p class="mb-0">Enjoy crystal-clear voice on every call.</p>
                            </div>  
                        </li>
                        <li>
                            <div class="list-text d-flex flex-column">
                                <div class="list-heading">Multi-Tenant Architecture</div>
                                <p class="mb-0">Manage multiple clients or branches with ease.</p>
                            </div>  
                        </li>
                        <li>
                            <div class="list-text d-flex flex-column">
                                <div class="list-heading">Auto Attendant</div>
                                <p class="mb-0">Automate call handling with professional greetings.</p>
                            </div>  
                        </li>
                        <li>
                            <div class="list-text d-flex flex-column">
                                <div class="list-heading">Voicemail to Email</div>
                                <p class="mb-0">Access voicemails directly from your inbox.</p>
                            </div>  
                        </li>
                        <li>
                            <div class="list-text d-flex flex-column">
                                <div class="list-heading">Call Recording & Monitoring</div>
                                <p class="mb-0">Keep track of all conversations securely.</p>
                            </div>  
                        </li>
                        <li>
                            <div class="list-text d-flex flex-column">
                                <div class="list-heading">Advanced Call Analytics</div>
                                <p class="mb-0">Gain insights with detailed reporting tools.</p>
                            </div>  
                        </li>
                        <li>
                            <div class="list-text d-flex flex-column">
                                <div class="list-heading">Integration with CRMs</div>
                                <p class="mb-0">Sync with business tools for a unified workflow.</p>
                            </div>  
                        </li>
                        <li>
                            <div class="list-text d-flex flex-column">
                                <div class="list-heading">Secure Remote Access</div>
                                <p class="mb-0">Support hybrid teams with encrypted remote calling.</p>
                            </div>  
                        </li>
                        <li>
                            <div class="list-text d-flex flex-column">
                                <div class="list-heading">Quick Installation & Setup</div>
                                <p class="mb-0">Get started without delays or downtime.</p>
                            </div>  
                        </li>
                    </ul>
                </div>
            ...
            <div class="col col-md-6">
                <div class="feat-img">
                    <img src="assets/images/ip-pbx-solution1.svg" alt="Why Choose VoipTechr Solutions For IP PBX?" class="img-fluid" loading="lazy" />
                </div>
            </div>
        </div>
        <!-- Faet 2 -->
        <div class="row flex-column-reverse flex-md-row-reverse align-items-center _feat-box py-4">
            <div class="col col-md-6">
                <h2>Key Benefits of Choosing <span class="text-orange">VoIPTech Solutions</span> for <span class="text-orange">IP PBX</span></h2>
                <div class="_content">
                    <ul class="list2">
                        <li>
                            <div class="list-text d-flex flex-column">
                                <div class="list-heading">Cost Savings</div>
                                <p class="mb-0">Reduce phone bills with internet-based calling and no hardware dependency.</p>
                            </div>
                        </li>
                        <li>
                            <div class="list-text d-flex flex-column">
                                <div class="list-heading">Scalability</div>
                                <p class="mb-0">Easily add users or features as your business grows.</p>
                            </div>  
                        </li>
                        <li>
                            <div class="list-text d-flex flex-column">
                                <div class="list-heading">Business Continuity</div>
                                <p class="mb-0">Stay connected even during power or network outages.</p>
                            </div>  
                        </li>
                        <li>
                            <div class="list-text d-flex flex-column">
                                <div class="list-heading">Remote Workforce Friendly</div>
                                <p class="mb-0">Enable seamless communication for on-site and remote teams.</p>
                            </div>  
                        </li>
                        <li>
                            <div class="list-text d-flex flex-column">
                                <div class="list-heading">Enhanced Productivity</div>
                                <p class="mb-0">Streamline operations with automation and integrations.</p>
                            </div>  
                        </li>
                        <li>
                            <div class="list-text d-flex flex-column">
                                <div class="list-heading">Reliable Support</div>
                                <p class="mb-0">Count on 24/7 technical assistance and proactive monitoring.</p>
                            </div>  
                        </li>
                    </ul>
                </div>
            ...
            <div class="col col-md-6">
                <div class="feat-img">
                    <img src="assets/images/ip-pbx-solution2.svg" alt="Key Benefits of Choosing Voip Tech Solutions for IP PBX" class="img-fluid" loading="lazy" />
                </div>
            </div>
        </div>
        <!-- Faet 3 -->
        <div class="row flex-column-reverse flex-md-row align-items-center _feat-box py-4">
            <div class="col col-md-6">
                <h2>How VoIPTech Solutions <span class="text-orange">IP PBX   </span>  Works</h2>
                <div class="_content">
                    <p>VoIPTech Solutions IP PBX simplifies business communication by providing a seamless, scalable, and feature-rich system. Here's how it works:</p>
                    <ul class="list2 ">
                        <li>
                            <div class="list-text d-flex flex-column">
                                <div class="list-heading">Step 1: Setup and Configuration</div>
                                <p class="mb-0">We install and configure your IP PBX system based on your business needs and user volume.</p>
                            </div>
                        </li>
                        <li>
                            <div class="list-text d-flex flex-column">
                                <div class="list-heading">Step 2: Connect Devices </div>
                                <p class="mb-0">Your phones, softphones, and mobile apps are connected via internet or local network.</p>
                            </div>
                        </li>
                        <li>
                            <div class="list-text d-flex flex-column">
                                <div class="list-heading">Step 3: Define Call Flows</div>
                                <p class="mb-0">Custom call routing rules, extensions, IVRs, and voicemail are set up for smooth operations.</p>
                            </div>
                        </li>
                        <li>
                            <div class="list-text d-flex flex-column">
                                <div class="list-heading">Step 4: Enable Features</div>
                                <p class="mb-0">Access all PBX features—call forwarding, conferencing, auto-attendant, and more.</p>
                            </div>
                        </li>
                        <li>
                            <div class="list-text d-flex flex-column">
                                <div class="list-heading">Step 5: Monitor and Manage</div>
                                <p class="mb-0">Track call data in real-time with dashboards and reports, plus manage the system from a secure web panel.</p>
                            </div>
                        </li>
            ...
            <div class="col col-md-6">
                <div class="feat-img">
                    <img src="assets/images/ip-pbx-solution3.svg" alt="How VoIPTech Solutions IP PBX Works" class="img-fluid" loading="lazy" />
                </div>
            </div>
        </div>
        ...
        <div class="row flex-column-reverse flex-md-row-reverse align-items-center _feat-box">
            <div class="col col-md-6">
                ...
                <div class="_content">
                    <p>We deliver scalable IP PBX solutions tailored to industry needs.</p>
                    <ul class="list2 icons-list">
                        <li>
                            <span class="_icn">🎓</span>
                            <div class="list-text d-flex flex-column">
                                <div class="list-heading">Education</div>
                                <p class="mb-0">Enable smooth communication across campuses.</p>
                            </div>
                        </li>
                        ...
                        <li>
                            ...
                            <div class="list-text d-flex flex-column">
                                ...
                                <p class="mb-0">Enhance guest experience with seamless calling.</p>
                            </div>  
                        </li>
                        <li>
                            <span class="_icn">📞</span>
                            <div class="list-text d-flex flex-column">
                                ...
                                <p class="mb-0">Boost agent productivity and call efficiency.</p>
                            </div>  
                        </li>
                        <li>
                            <span class="_icn">🛒</span>
                            <div class="list-text d-flex flex-column">
                                ...
                                <p class="mb-0">Improve sales and customer engagement.</p>
                            </div>  
                        </li>
                        <li>
                            <span class="_icn">🏥</span>
                        ...
                        <li>
                            ...
                            <div class="list-text d-flex flex-column">
                                ...
                                <p class="mb-0">Secure, reliable communication for patient care.</p>
                            </div>  
                        </li>
            ...
            <div class="process-box-cont">
                <div class="process-box">
                    <div class="process-body">
                        ...
                        <div class="_pro-content">
                            ...
                            <p>Reach out to discuss your business goals and IP PBX needs.</p>
                        </div>
                    </div>
                ...
                <div class="process-box">
                    <div class="process-body">
                        ...
                        <div class="_pro-content">
                            <h3>Custom Setup & Demo</h3>
                            <p>Get a tailored demo and choose between cloud or on-premise deployment.</p>
                        </div>
                    </div>
                    <div class="process-arrow">
                        <img src="assets/images/process-arrow.png" alt="Process Arrow" loading="lazy" />
                ...
                <div class="process-box">
                    <div class="process-body">
                        ...
                        <div class="_pro-content">
                            ...
                            <p>Go live with full system setup and dedicated 24/7 support.</p>
                        </div>
                    </div>
                    <div class="process-arrow">
                        <img src="assets/images/process-arrow.png" alt="Process Arrow" loading="lazy" />
