        ...
        <div class="container">
            <div class="d-flex justify-content-between flex-column flex-lg-row mt-5 align-items-start banner-content-container">
                ...
                <div class="banner-content">
                    <h1>Reliable Class 4 Softswitch Providers for Carriers & VoIP Businesses</h1>
                    <p>Seamless VoIP Routing for Global-Scale Communication</p>
                    <div class="banner-feats">
                        <div class="feat-item">
                            ...
                            <div class="_feat">
                                ...
                                <p>Smart routing to reduce telecom expenses.</p>
                            </div>
                        </div>
                        <div class="feat-item">
                            ...
                            <div class="_feat">
                                ...
                                <p>Supports thousands of concurrent calls effortlessly.</p>
                            </div>
                        </div>
                        <div class="feat-item">
                            <div class="feat-icn"><img src="assets/images/icons/feat-icn3.png" alt="Cost-Effective Communication" /></div>
                            <div class="_feat">
                                <div class="_feat-head">Global Routing</div>
                                <p>Connect carriers across the globe without disruptions.</p>
                            </div>
                        </div>
                        <div class="feat-item">
                            <div class="feat-icn"><img src="assets/images/icons/feat-icn4.png" alt="Cost-Effective Communication" /></div>
                            <div class="_feat">
                                <div class="_feat-head">Advanced Billing</div>
                                <p>Real-time billing, rate plans, and detailed CDRs.</p>
                            </div>
                        </div>
                        <div class="feat-item">
                            <div class="feat-icn"><img src="assets/images/icons/feat-icn5.png" alt="Cost-Effective Communication" /></div>
                            <div class="_feat">
                                <div class="_feat-head">Secure Infrastructure</div>
                                <p>Built-in fraud detection, encryption, and traffic filters.</p>
                            </div>
                        </div>
                        <div class="feat-item">
                            <div class="feat-icn"><img src="assets/images/icons/feat-icn6.png" alt="Cost-Effective Communication" /></div>
                            <div class="_feat">
                                <div class="_feat-head">Scalable Deployment</div>
                                <p>Easily expand capacity as your VoIP traffic grows.</p>
                            </div>
                        </div>
                    </div>
    ...
    <div class="container">
        ...
        <div class="row flex-column-reverse flex-md-row align-items-center _feat-box">
            <div class="col col-md-6">
                <h2>Why Choose <span class="text-orange">VoIPTech Solutions </span> For <span class="text-orange">Class 4 Softswitch?</span> </h2>
                <div class="_content">
                    <ul class="list2">
                        <li>
                            <div class="list-text d-flex flex-column">
                                <div class="list-heading">Least Cost Routing (LCR)</div>
                                <p class="mb-0">Automatically selects the most economical route for each call.</p>
                            </div>
                        </li>
                        <li>
                            <div class="list-text d-flex flex-column">
                                <div class="list-heading">Real-Time Traffic Monitoring</div>
                                <p class="mb-0">Gain live insights into call performance and system status.</p>
                            </div>  
                        </li>
                        <li>
                            <div class="list-text d-flex flex-column">
                                <div class="list-heading">Multi-Protocol Support</div>
                                <p class="mb-0">Compatible with SIP, H.323, and various codecs.</p>
                            </div>  
                        </li>
                        <li>
                            <div class="list-text d-flex flex-column">
                                <div class="list-heading">Carrier Interconnect Management</div>
                                <p class="mb-0">Streamlines connections with multiple telecom carriers.</p>
                            </div>  
                        </li>
                        <li>
                            <div class="list-text d-flex flex-column">
                                <div class="list-heading">Dynamic Routing Rules</div>
                                <p class="mb-0">Set flexible rules based on quality, cost, and destination.</p>
                            </div>  
                        </li>
                        <li>
                            <div class="list-text d-flex flex-column">
                                <div class="list-heading">Secure Call Authentication</div>
                                <p class="mb-0">Ensures only valid traffic passes through your switch.</p>
                            </div>  
                        </li>
                        <li>
                            <div class="list-text d-flex flex-column">
                                <div class="list-heading">Automatic Failover</div>
                                <p class="mb-0">Keeps traffic flowing even during route failures.</p>
                            </div>  
                        </li>
                        <li>
                            <div class="list-text d-flex flex-column">
                                <div class="list-heading">Customizable Rate Plans</div>
                                <p class="mb-0">Create tailored billing structures for partners or customers.</p>
                            </div>  
                        </li>
                        <li>
                            <div class="list-text d-flex flex-column">
                                <div class="list-heading">Fraud Detection & Prevention</div>
                                <p class="mb-0">Blocks suspicious activity before it affects your bottom line.</p>
                            </div>  
                        </li>
                        <li>
                            <div class="list-text d-flex flex-column">
                                <div class="list-heading">Cloud or On-Premise Deployment</div>
                                <p class="mb-0">Choose what fits your business model best.</p>
                            </div>  
                        </li>
                    </ul>
                </div>
            ...
            <div class="col col-md-6">
                <div class="feat-img">
                    <img src="assets/images/class4-solution1.svg" alt="Why Choose VoipTechr Solutions For Class 4 Softswitch?" class="img-fluid" loading="lazy" />
                </div>
            </div>
        </div>
        <!-- Faet 2 -->
        <div class="row flex-column-reverse flex-md-row-reverse align-items-center _feat-box py-4">
            <div class="col col-md-6">
                <h2>Key Benefits of Choosing <span class="text-orange">VoIPTech Solutions</span> for <span class="text-orange">Class 4 Softswitch</span></h2>
                <div class="_content">
                    <ul class="list2">
                        <li>
                            <div class="list-text d-flex flex-column">
                                <div class="list-heading">Carrier-Grade Performance</div>
                                <p class="mb-0">Engineered to handle high volumes of long-distance traffic.</p>
                            </div>
                        </li>
                        <li>
                            <div class="list-text d-flex flex-column">
                                <div class="list-heading">Maximized Profit Margins</div>
                                <p class="mb-0">Optimized routing reduces costs while maintaining quality.</p>
                            </div>  
                        </li>
                        <li>
                            <div class="list-text d-flex flex-column">
                                <div class="list-heading">Fast, Flexible Setup</div>
                                <p class="mb-0">Minimal setup time with tailored configurations.</p>
                            </div>  
                        </li>
                        <li>
                            <div class="list-text d-flex flex-column">
                                <div class="list-heading">Global Reach, Local Support</div>
                                <p class="mb-0">Route international traffic while enjoying local tech support.</p>
                            </div>  
                        </li>
                        <li>
                            <div class="list-text d-flex flex-column">
                                <div class="list-heading">Data-Driven Optimization</div>
                                <p class="mb-0">Leverage call data to improve quality and cost-efficiency.</p>
                            </div>  
                        </li>
                        <li>
                            <div class="list-text d-flex flex-column">
                                <div class="list-heading">Expert Support, Always On</div>
                                <p class="mb-0">Our engineers are on call 24/7 to assist you.</p>
                            </div>  
                        </li>
                    </ul>
                </div>
            ...
            <div class="col col-md-6">
                <div class="feat-img">
                    <img src="assets/images/class4-solution2.svg" alt="Key Benefits of Choosing Voip Tech Solutions for Class 4 Softswitch" class="img-fluid" loading="lazy" />
                </div>
            </div>
        </div>
        <!-- Faet 3 -->
        <div class="row flex-column-reverse flex-md-row align-items-center _feat-box py-4">
            <div class="col col-md-6">
                <h2>How VoIPTech Solutions <span class="text-orange">Class 4 Softswitch </span>  Works</h2>
                <div class="_content">
                    <p>Our Class 4 Softswitch is designed for high-performance routing across global VoIP networks. Here's how it delivers:</p>
                    <ul class="list2 ">
                        <li>
                            <div class="list-text d-flex flex-column">
                                <div class="list-heading">Step 1: Ingest Call Traffic</div>
                                <p class="mb-0">Receives inbound VoIP calls from carriers and clients.</p>
                            </div>
                        </li>
                        <li>
                            <div class="list-text d-flex flex-column">
                                <div class="list-heading">Step 2: Authenticate & Validate</div>
                                <p class="mb-0">Applies SIP authentication and route permissions.</p>
                            </div>
                        </li>
                        <li>
                            <div class="list-text d-flex flex-column">
                                <div class="list-heading">Step 3: Intelligent Routing</div>
                                <p class="mb-0">Routes calls using LCR, quality-based, or custom rules.</p>
                            </div>
                        </li>
                        <li>
                            <div class="list-text d-flex flex-column">
                                <div class="list-heading">Step 4: Call Termination</div>
                                <p class="mb-0">Delivers the call to the destination carrier/network.</p>
                            </div>
                        </li>
                        <li>
                            <div class="list-text d-flex flex-column">
                                <div class="list-heading">Step 5: Monitor & Bill</div>
                                <p class="mb-0">Generates real-time CDRs, billing, and performance reports.</p>
                            </div>
                        </li>
            ...
            <div class="col col-md-6">
                <div class="feat-img">
                    <img src="assets/images/class4-solution3.svg" alt="How VoIPTech Solutions Fusion PBX Works" class="img-fluid" loading="lazy" />
                </div>
            </div>
        </div>
        ...
        <div class="row flex-column-reverse flex-md-row-reverse align-items-center _feat-box">
            <div class="col col-md-6">
                ...
                <div class="_content">
                    <p>VoIPTech Solutions Class 4 Softswitch empowers carriers and wholesale providers with powerful, secure, and scalable switching solutions.</p>
                    <ul class="list2 icons-list">
                        <li>
                            <span class="_icn">📞</span>
                            <div class="list-text d-flex flex-column">
                                <div class="list-heading">Telecom Carriers</div>
                                <p class="mb-0">Ensure smooth, secure call routing across networks.</p>
                            </div>
                        </li>
                        <li>
                            <span class="_icn">📡</span>
                            <div class="list-text d-flex flex-column">
                                <div class="list-heading">VoIP Wholesale Providers</div>
                                <p class="mb-0">Manage massive traffic loads with ease and cost-efficiency.</p>
                            </div>  
                        </li>
                        <li>
                            <span class="_icn">🌐</span>
                            <div class="list-text d-flex flex-column">
                                <div class="list-heading">ISPs & Internet Telephony </div>
                                <p class="mb-0">Add high-volume voice services to your offerings.</p>
                            </div>  
                        </li>
                        <li>
                            <span class="_icn">💼</span>
                            <div class="list-text d-flex flex-column">
                                <div class="list-heading">Managed Service Providers</div>
                                <p class="mb-0">Offer advanced call routing as a service to your clients.</p>
                            </div>  
                        </li>
                        <li>
                            <span class="_icn">🏢</span>
                            <div class="list-text d-flex flex-column">
                                <div class="list-heading">Corporate Telcos</div>
                                <p class="mb-0">Handle large-scale internal and external voice communication.</p>
                            </div>  
                        </li>
                        <li>
                            <span class="_icn">🔧</span>
                            <div class="list-text d-flex flex-column">
                                <div class="list-heading">Tech Infrastructure Providers </div>
                                <p class="mb-0">Build reliable telecom backbones with advanced switching.</p>
                            </div>  
                        </li>
            ...
            <div class="col col-md-6">
                <div class="feat-img">
                    <img src="assets/images/class4-solution4.svg" alt="Industries We Serve" class="img-fluid" loading="lazy" />
                </div>
            </div>
        </div>
            ...
            <div class="process-box-cont">
                <div class="process-box">
                    <div class="process-body">
                        ...
                        <div class="_pro-content">
                            ...
                            <p>Speak with our VoIP experts about your traffic and routing needs.</p>
                        </div>
                    </div>
                ...
                <div class="process-box">
                    <div class="process-body">
                        ...
                        <div class="_pro-content">
                            <h3>Tailor Your Solution</h3>
                            <p>We’ll deploy a switch configured for your volume and regions.</p>
                        </div>
                    </div>
                    <div class="process-arrow">
                        <img src="assets/images/process-arrow.png" alt="Process Arrow" loading="lazy" />
                ...
                <div class="process-box">
                    <div class="process-body">
                        ...
                        <div class="_pro-content">
                            ...
                            <p>Start routing calls globally with full support and monitoring tools.</p>
                        </div>
                    </div>
                    <div class="process-arrow">
                        <img src="assets/images/process-arrow.png" alt="Process Arrow" loading="lazy" />
